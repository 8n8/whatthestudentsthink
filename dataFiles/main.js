...
var $author$project$Update$intToNss = function (i) {
	return {
		max: $author$project$Update$unwrap(
			A2($elm$core$Basics$modBy, 100, i)),
		min: $author$project$Update$unwrap(
			A2($elm$core$Basics$modBy, 100, (i / 10000) | 0)),
		q: A2($elm$core$Basics$modBy, 100, (i / 1000000) | 0),
		uni: A2($elm$core$Basics$modBy, 1000, (i / 100000000) | 0),
		value: $author$project$Update$unwrap(
			A2($elm$core$Basics$modBy, 100, (i / 100) | 0))
	};
};
var $author$project$Data$nss = _List_fromArray(
	[11301909193]);
var $author$project$Update$nss = A2($elm$core$List$map, $author$project$Update$intToNss, $author$project$Data$nss);
	...
	function (qList, uniList) {
		...
		return A2(
			...
			A2(
				...
				A2(
					$elm$core$List$map,
					$author$project$Update$getDataPoint,
					A2(
						$elm$core$List$filter,
						A2($author$project$Update$matching, qS, uniS),
						$author$project$Update$nss))));
	});
...
var $author$project$Update$intToNss2 = function (ii) {
	var i = A2($elm$core$Debug$log, 'i', ii);
	var over100 = A2($elm$core$Debug$log, 'over100', (i / 100) | 0);
	var r = A2(
		$elm$core$Debug$log,
		'r',
		{
			...
			min: $author$project$Update$unwrap(
				A2($elm$core$Basics$modBy, 100, (i / 10000) | 0)),
			q: A2($elm$core$Basics$modBy, 100, (i / 1000000) | 0),
			subject: A2($elm$core$Basics$modBy, 1000, (i / 100000000) | 0),
			uni: A2($elm$core$Basics$modBy, 1000, (i / 100000000000) | 0),
			value: $author$project$Update$unwrap(
				A2($elm$core$Basics$modBy, 100, over100))
		});
	return r;
};
var $author$project$Data$nss2 = _List_fromArray(
	[15208501919799]);
var $author$project$Update$nss2 = A2($elm$core$List$map, $author$project$Update$intToNss2, $author$project$Data$nss2);
	...
	function (subject, questionList, uniList) {
		...
		return A2(
			...
			A2(
				...
				A2(
					$elm$core$List$map,
					$author$project$Update$getDataPoint2,
					A2(
						$elm$core$List$filter,
						A3($author$project$Update$matching2, subject, qS, uniS),
						$author$project$Update$nss2))));
	});
		...
		if (_v0.$ === 'BySubject') {
			if (_v0.a.$ === 'Nothing') {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							data: A3($author$project$Update$getSubjectData, subj, questions, unis)
						}),
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						data: A2($author$project$Update$getOverallData, questions, unis)
					}),
				$elm$core$Platform$Cmd$none);
		}
	}
};
var $author$project$DataTypes$FoldedUp = {$: 'FoldedUp'};
var $author$project$DataTypes$Overall = {$: 'Overall'};
var $author$project$DataTypes$UniVsA = {$: 'UniVsA'};
...
var $author$project$Data$overallUniCodes = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			...
			_Utils_Tuple2(2, 'Aberystwyth University'),
			_Utils_Tuple2(3, 'Anglia Ruskin University Higher Corporation'),
			_Utils_Tuple2(4, 'Arden University Limited'),
			_Utils_Tuple2(5, 'Arts University Bournemouth, the'),
			_Utils_Tuple2(6, 'Aston University'),
			_Utils_Tuple2(7, 'BIMM Limited'),
			_Utils_Tuple2(8, 'BPP University Limited'),
			...
			_Utils_Tuple2(24, 'De Montfort University'),
			_Utils_Tuple2(25, 'Edge Hill University'),
			_Utils_Tuple2(26, 'Edinburgh Napier University'),
			_Utils_Tuple2(27, 'Falmouth University'),
			_Utils_Tuple2(28, 'GSM London Limited'),
			...
			_Utils_Tuple2(48, 'Loughborough University'),
			_Utils_Tuple2(49, 'Manchester Metropolitan University'),
			_Utils_Tuple2(50, 'Middlesex University'),
			_Utils_Tuple2(51, 'Newman University'),
			_Utils_Tuple2(52, 'Norwich University of the Arts'),
			_Utils_Tuple2(53, 'Nottingham Trent University'),
			_Utils_Tuple2(54, 'Oxford Brookes University'),
			_Utils_Tuple2(55, 'Plymouth College of Art'),
			_Utils_Tuple2(56, 'QAHE (UR) Limited'),
			_Utils_Tuple2(57, 'Queen Margaret University, Edinburgh'),
			_Utils_Tuple2(58, 'Queen Mary University of London'),
			_Utils_Tuple2(59, 'Queen\'s University of Belfast'),
			_Utils_Tuple2(60, 'Ravensbourne University London'),
			_Utils_Tuple2(61, 'Regent\'s University London'),
			_Utils_Tuple2(62, 'Roehampton University'),
			_Utils_Tuple2(63, 'Royal Conservatoire of Scotland'),
			_Utils_Tuple2(64, 'Royal Holloway and Bedford New College'),
			_Utils_Tuple2(65, 'SAE Education Limited'),
			_Utils_Tuple2(66, 'SRUC'),
			_Utils_Tuple2(67, 'Sheffield Hallam University'),
			_Utils_Tuple2(68, 'Solent University'),
			_Utils_Tuple2(69, 'St Mary\'s University College'),
			_Utils_Tuple2(70, 'St Mary\'s University, Twickenham'),
			_Utils_Tuple2(71, 'St. George\'s Hospital Medical School'),
			_Utils_Tuple2(72, 'Staffordshire University'),
			_Utils_Tuple2(73, 'Stranmillis University College'),
			_Utils_Tuple2(74, 'Swansea University'),
			_Utils_Tuple2(75, 'Teesside University'),
			_Utils_Tuple2(76, 'The Conservatoire for Dance and Drama'),
			_Utils_Tuple2(77, 'The Liverpool Institute for Performing Arts'),
			_Utils_Tuple2(78, 'The London School of Economics and Political Science'),
			_Utils_Tuple2(79, 'The Open University'),
			_Utils_Tuple2(80, 'The Robert Gordon University'),
			_Utils_Tuple2(81, 'The Royal Agricultural University'),
			_Utils_Tuple2(82, 'The Royal Veterinary College'),
			_Utils_Tuple2(83, 'The School of Oriental and African Studies'),
			_Utils_Tuple2(84, 'The University of Bath'),
			_Utils_Tuple2(85, 'The University of Birmingham'),
			_Utils_Tuple2(86, 'The University of Bolton'),
			_Utils_Tuple2(87, 'The University of Bradford'),
			_Utils_Tuple2(88, 'The University of Buckingham'),
			_Utils_Tuple2(89, 'The University of Chichester'),
			_Utils_Tuple2(90, 'The University of Cumbria'),
			_Utils_Tuple2(91, 'The University of East Anglia'),
			_Utils_Tuple2(92, 'The University of Essex'),
			_Utils_Tuple2(93, 'The University of Huddersfield'),
			_Utils_Tuple2(94, 'The University of Hull'),
			_Utils_Tuple2(95, 'The University of Kent'),
			_Utils_Tuple2(96, 'The University of Lancaster'),
			_Utils_Tuple2(97, 'The University of Law Limited'),
			_Utils_Tuple2(98, 'The University of Leeds'),
			_Utils_Tuple2(99, 'The University of Leicester'),
			_Utils_Tuple2(100, 'The University of Liverpool'),
			_Utils_Tuple2(101, 'The University of Manchester'),
			_Utils_Tuple2(102, 'The University of Reading'),
			_Utils_Tuple2(103, 'The University of Sheffield'),
			_Utils_Tuple2(104, 'The University of Surrey'),
			_Utils_Tuple2(105, 'The University of Warwick'),
			_Utils_Tuple2(106, 'The University of West London'),
			_Utils_Tuple2(107, 'The University of Westminster'),
			_Utils_Tuple2(108, 'UCFB College of Football Business Limited'),
			_Utils_Tuple2(109, 'University College Birmingham'),
			_Utils_Tuple2(110, 'University College London'),
			_Utils_Tuple2(111, 'University College of Estate Management'),
			_Utils_Tuple2(112, 'University for the Creative Arts'),
			_Utils_Tuple2(113, 'University of Aberdeen'),
			_Utils_Tuple2(114, 'University of Abertay Dundee'),
			_Utils_Tuple2(115, 'University of Bedfordshire'),
			_Utils_Tuple2(116, 'University of Brighton'),
			_Utils_Tuple2(117, 'University of Bristol'),
			_Utils_Tuple2(118, 'University of Central Lancashire'),
			_Utils_Tuple2(119, 'University of Chester'),
			_Utils_Tuple2(120, 'University of Derby'),
			_Utils_Tuple2(121, 'University of Dundee'),
			_Utils_Tuple2(122, 'University of Durham'),
			_Utils_Tuple2(123, 'University of East London'),
			_Utils_Tuple2(124, 'University of Edinburgh'),
			_Utils_Tuple2(125, 'University of Exeter'),
			_Utils_Tuple2(126, 'University of Glasgow'),
			_Utils_Tuple2(127, 'University of Gloucestershire'),
			_Utils_Tuple2(128, 'University of Greenwich'),
			_Utils_Tuple2(129, 'University of Hertfordshire'),
			_Utils_Tuple2(130, 'University of Keele'),
			_Utils_Tuple2(131, 'University of Lincoln'),
			_Utils_Tuple2(132, 'University of Newcastle upon Tyne'),
			_Utils_Tuple2(133, 'University of Northampton, The'),
			_Utils_Tuple2(134, 'University of Northumbria at Newcastle'),
			_Utils_Tuple2(135, 'University of Nottingham, The'),
			_Utils_Tuple2(136, 'University of Plymouth'),
			_Utils_Tuple2(137, 'University of Portsmouth'),
			_Utils_Tuple2(138, 'University of Salford, The'),
			_Utils_Tuple2(139, 'University of South Wales'),
			_Utils_Tuple2(140, 'University of Southampton'),
			_Utils_Tuple2(141, 'University of St Andrews'),
			_Utils_Tuple2(142, 'University of St Mark & St John'),
			_Utils_Tuple2(143, 'University of Stirling'),
			_Utils_Tuple2(144, 'University of Strathclyde'),
			_Utils_Tuple2(145, 'University of Suffolk'),
			_Utils_Tuple2(146, 'University of Sunderland'),
			_Utils_Tuple2(147, 'University of Sussex'),
			_Utils_Tuple2(148, 'University of Ulster'),
			_Utils_Tuple2(149, 'University of Wales Trinity Saint David'),
			_Utils_Tuple2(150, 'University of Winchester'),
			_Utils_Tuple2(151, 'University of Wolverhampton'),
			_Utils_Tuple2(152, 'University of Worcester'),
			_Utils_Tuple2(153, 'University of York'),
			_Utils_Tuple2(154, 'University of the Arts, London'),
			_Utils_Tuple2(155, 'University of the Highlands and Islands'),
			_Utils_Tuple2(156, 'University of the West of England, Bristol'),
			_Utils_Tuple2(157, 'University of the West of Scotland'),
			_Utils_Tuple2(158, 'Wrexham Glyndŵr University'),
			_Utils_Tuple2(159, 'York St John University')
		]));
var $author$project$Data$subjectCodes = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			...
			_Utils_Tuple2(19, 'Biosciences (non-specific)'),
			_Utils_Tuple2(20, 'Biotechnology'),
			_Utils_Tuple2(21, 'Building'),
			_Utils_Tuple2(22, 'Business studies'),
			_Utils_Tuple2(23, 'Chemical, process and energy engineering'),
			_Utils_Tuple2(24, 'Chemistry'),
			_Utils_Tuple2(25, 'Childhood and youth studies'),
			_Utils_Tuple2(26, 'Children\'s nursing'),
			_Utils_Tuple2(27, 'Cinematics and photography'),
			_Utils_Tuple2(28, 'Civil engineering'),
			_Utils_Tuple2(29, 'Classics'),
			_Utils_Tuple2(30, 'Combined, general or negotiated studies'),
			_Utils_Tuple2(31, 'Complementary and alternative medicine'),
			_Utils_Tuple2(32, 'Computer games and animation'),
			_Utils_Tuple2(33, 'Computer science'),
			_Utils_Tuple2(34, 'Counselling, psychotherapy and occupational therapy'),
			_Utils_Tuple2(35, 'Creative writing'),
			_Utils_Tuple2(36, 'Dance'),
			_Utils_Tuple2(37, 'Dentistry'),
			_Utils_Tuple2(38, 'Design studies'),
			_Utils_Tuple2(39, 'Development studies'),
			_Utils_Tuple2(40, 'Developmental psychology'),
			_Utils_Tuple2(41, 'Drama'),
			_Utils_Tuple2(42, 'Earth sciences'),
			_Utils_Tuple2(43, 'Ecology and environmental biology'),
			_Utils_Tuple2(44, 'Economics'),
			_Utils_Tuple2(45, 'Education'),
			_Utils_Tuple2(46, 'Electrical and electronic engineering'),
			_Utils_Tuple2(47, 'Engineering (non-specific)'),
			_Utils_Tuple2(48, 'English language'),
			_Utils_Tuple2(49, 'English studies (non-specific)'),
			_Utils_Tuple2(50, 'Environmental and public health'),
			_Utils_Tuple2(51, 'Environmental sciences'),
			_Utils_Tuple2(52, 'Finance'),
			_Utils_Tuple2(53, 'Food and beverage production'),
			_Utils_Tuple2(54, 'Food and beverage studies (non-specific)'),
			_Utils_Tuple2(55, 'Food sciences'),
			_Utils_Tuple2(56, 'Forensic and archaeological sciences'),
			_Utils_Tuple2(57, 'French studies'),
			_Utils_Tuple2(58, 'Genetics'),
			_Utils_Tuple2(59, 'German and Scandinavian studies'),
			_Utils_Tuple2(60, 'Health studies'),
			_Utils_Tuple2(61, 'History'),
			_Utils_Tuple2(62, 'History of art, architecture and design'),
			_Utils_Tuple2(63, 'Human geography'),
			_Utils_Tuple2(64, 'Human resource management'),
			_Utils_Tuple2(65, 'Humanities (non-specific)'),
			_Utils_Tuple2(66, 'Iberian studies'),
			_Utils_Tuple2(67, 'Information services'),
			_Utils_Tuple2(68, 'Information systems'),
			_Utils_Tuple2(69, 'Italian studies'),
			_Utils_Tuple2(70, 'Journalism'),
			_Utils_Tuple2(71, 'Landscape design'),
			_Utils_Tuple2(72, 'Law'),
			_Utils_Tuple2(73, 'Learning disabilities nursing'),
			_Utils_Tuple2(74, 'Linguistics'),
			_Utils_Tuple2(75, 'Literature in English'),
			_Utils_Tuple2(76, 'Management studies'),
			_Utils_Tuple2(77, 'Maritime technology'),
			_Utils_Tuple2(78, 'Marketing'),
			_Utils_Tuple2(79, 'Materials science'),
			_Utils_Tuple2(80, 'Materials technology'),
			_Utils_Tuple2(81, 'Mathematics'),
			_Utils_Tuple2(82, 'Mechanical engineering'),
			_Utils_Tuple2(83, 'Media studies'),
			_Utils_Tuple2(84, 'Medical technology'),
			_Utils_Tuple2(85, 'Medicine (non-specific)'),
			_Utils_Tuple2(86, 'Mental health nursing'),
			_Utils_Tuple2(87, 'Microbiology and cell science'),
			_Utils_Tuple2(88, 'Midwifery'),
			_Utils_Tuple2(89, 'Molecular biology, biophysics and biochemistry'),
			_Utils_Tuple2(90, 'Music'),
			_Utils_Tuple2(91, 'Naval architecture'),
			_Utils_Tuple2(92, 'Nursing (non-specific)'),
			_Utils_Tuple2(93, 'Nutrition and dietetics'),
			_Utils_Tuple2(94, 'Operational research'),
			_Utils_Tuple2(95, 'Ophthalmics'),
			_Utils_Tuple2(96, 'Others in biosciences'),
			_Utils_Tuple2(97, 'Others in business and management'),
			_Utils_Tuple2(98, 'Others in creative arts and design'),
			_Utils_Tuple2(99, 'Others in language and area studies'),
			_Utils_Tuple2(100, 'Others in nursing'),
			_Utils_Tuple2(101, 'Others in psychology'),
			_Utils_Tuple2(102, 'Others in subjects allied to medicine'),
			_Utils_Tuple2(103, 'Others in technology'),
			_Utils_Tuple2(104, 'Others in veterinary sciences'),
			_Utils_Tuple2(105, 'Personal development'),
			_Utils_Tuple2(106, 'Pharmacology'),
			_Utils_Tuple2(107, 'Pharmacy'),
			_Utils_Tuple2(108, 'Philosophy'),
			_Utils_Tuple2(109, 'Physical geographical sciences'),
			_Utils_Tuple2(110, 'Physical sciences (non-specific)'),
			_Utils_Tuple2(111, 'Physics'),
			_Utils_Tuple2(112, 'Physiotherapy'),
			_Utils_Tuple2(113, 'Planning (urban, rural and regional)'),
			_Utils_Tuple2(114, 'Politics'),
			_Utils_Tuple2(115, 'Polymers and textiles'),
			_Utils_Tuple2(116, 'Production and manufacturing engineering'),
			_Utils_Tuple2(117, 'Psychology (non-specific)'),
			_Utils_Tuple2(118, 'Publicity studies'),
			_Utils_Tuple2(119, 'Publishing'),
			_Utils_Tuple2(120, 'Rural estate management'),
			_Utils_Tuple2(121, 'Slavic studies'),
			_Utils_Tuple2(122, 'Social policy'),
			_Utils_Tuple2(123, 'Social sciences (non-specific)'),
			_Utils_Tuple2(124, 'Social work'),
			_Utils_Tuple2(125, 'Sociology'),
			_Utils_Tuple2(126, 'Software engineering'),
			_Utils_Tuple2(127, 'Sport and exercise sciences'),
			_Utils_Tuple2(128, 'Statistics'),
			_Utils_Tuple2(129, 'Teacher training'),
			_Utils_Tuple2(130, 'Theology and religious studies'),
			_Utils_Tuple2(131, 'Tourism, transport and travel'),
			_Utils_Tuple2(132, 'Veterinary medicine and dentistry'),
			_Utils_Tuple2(133, 'Zoology')
		]));
var $author$project$Main$initModel = {
	axesConfig: $author$project$DataTypes$UniVsA,
	chartMode: $author$project$DataTypes$Overall,
	chooserMode: $author$project$DataTypes$FoldedUp,
	data: _List_Nil,
	fatalErr: $elm$core$Maybe$Nothing,
	getRequestErr: $elm$core$Maybe$Nothing,
	pageLoading: false,
	questions: _List_fromArray(
		[27]),
	subjectSearchIndex: $author$project$Update$makeSearchIndex($author$project$Data$subjectCodes),
	subjectSearchResults: _List_Nil,
	uniSearchIndex: $author$project$Update$makeSearchIndex($author$project$Data$overallUniCodes),
	uniSearchResults: _List_Nil,
	unis: $elm$core$Dict$keys($author$project$Data$overallUniCodes)
};
...
var $author$project$DataTypes$BySubject = function (a) {
	return {$: 'BySubject', a: a};
};
var $author$project$DataTypes$QVsA = {$: 'QVsA'};
var $author$project$DataTypes$Question = {$: 'Question'};
...
var $author$project$Data$subjectsOffered = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			...
			4,
			_List_fromArray(
				[22, 27, 33, 35, 41, 45, 52, 61, 63, 72, 75, 76, 81, 83, 109, 114, 117, 125, 133])),
			_Utils_Tuple2(
			5,
			_List_fromArray(
				[1, 2, 21, 22, 26, 27, 32, 33, 38, 41, 45, 52, 56, 72, 75, 76, 83, 86, 88, 89, 95, 100, 102, 117, 124, 125, 127, 133])),
			_Utils_Tuple2(
			6,
			_List_fromArray(
				[12])),
			...
			10,
			_List_fromArray(
				[1, 22, 23, 33, 44, 48, 72, 78, 81, 82, 95, 96, 107, 114, 117, 125, 128])),
			_Utils_Tuple2(
			11,
			_List_fromArray(
				[70, 90, 131])),
			...
			13,
			_List_fromArray(
				[1, 2, 22, 33, 35, 43, 45, 51, 52, 61, 72, 75, 83, 109, 117, 125, 127, 129, 133])),
			_Utils_Tuple2(
			14,
			_List_fromArray(
				[13, 22, 35, 38, 41, 45, 61, 75, 83, 90, 98, 109, 117, 119, 125])),
			_Utils_Tuple2(
			15,
			_List_fromArray(
				[1, 15, 22, 33, 44, 61, 72, 76, 83, 89, 99, 108, 114, 117])),
			_Utils_Tuple2(
			16,
			_List_fromArray(
				[1, 2, 12, 13, 21, 22, 26, 27, 32, 33, 38, 41, 44, 45, 46, 49, 52, 64, 72, 76, 78, 82, 83, 84, 86, 88, 90, 98, 102, 117, 119, 124, 125, 129])),
			_Utils_Tuple2(
			17,
			_List_fromArray(
				[45, 117, 129])),
			...
			20,
			_List_fromArray(
				[1, 2, 9, 10, 22, 27, 32, 33, 38, 47, 49, 52, 56, 70, 72, 76, 78, 83, 88, 96, 102, 103, 125, 127, 131])),
			_Utils_Tuple2(
			21,
			_List_fromArray(
				[45])),
			...
			23,
			_List_fromArray(
				[1, 3, 22, 27, 28, 32, 33, 34, 38, 41, 44, 45, 46, 49, 52, 61, 72, 81, 82, 89, 112, 114, 117, 125, 127])),
			_Utils_Tuple2(
			24,
			_List_fromArray(
				[2, 26, 33, 38, 76, 86, 117, 125, 127, 131])),
			_Utils_Tuple2(
			25,
			_List_fromArray(
				[1, 2, 22, 27, 33, 34, 45, 52, 56, 60, 61, 72, 78, 83, 86, 88, 90, 117, 125, 127, 129])),
			_Utils_Tuple2(
			26,
			_List_fromArray(
				[1, 13, 22, 33, 38, 45, 60, 78, 93, 96, 102, 117, 127, 131])),
			_Utils_Tuple2(
			27,
			_List_fromArray(
				[1, 10, 12, 18, 22, 24, 28, 33, 34, 37, 42, 44, 48, 52, 56, 57, 61, 63, 66, 70, 72, 75, 81, 82, 83, 84, 85, 89, 90, 92, 95, 96, 102, 107, 108, 109, 111, 112, 113, 114, 117, 125, 126, 130])),
			_Utils_Tuple2(
			28,
			_List_fromArray(
				[1, 22, 26, 28, 33, 44, 52, 70, 72, 76, 81, 82, 84, 88, 95, 102, 114, 117, 125])),
			_Utils_Tuple2(
			29,
			_List_fromArray(
				[62])),
			...
			30,
			_List_fromArray(
				[1, 2, 3, 7, 12, 13, 21, 22, 25, 27, 28, 33, 34, 38, 41, 44, 46, 49, 52, 56, 61, 63, 64, 70, 72, 76, 78, 81, 82, 83, 93, 102, 109, 112, 114, 117, 124, 125, 127, 131])),
			_Utils_Tuple2(
			31,
			_List_fromArray(
				[1, 2, 12, 13, 22, 24, 26, 27, 32, 33, 35, 38, 41, 44, 45, 48, 49, 52, 56, 61, 64, 68, 70, 72, 78, 82, 83, 86, 102, 103, 107, 114, 117, 122, 123, 125])),
			_Utils_Tuple2(
			32,
			_List_fromArray(
				[90])),
			...
			34,
			_List_fromArray(
				[2, 22, 25, 26, 27, 33, 35, 41, 45, 72, 75, 76, 83, 86, 90, 93, 100, 109, 117, 122, 124, 125, 127, 129])),
			_Utils_Tuple2(
			35,
			_List_fromArray(
				[1, 2, 18, 21, 22, 26, 28, 33, 38, 47, 49, 57, 68, 72, 73, 76, 78, 83, 86, 87, 88, 117, 125, 126, 127, 131])),
			_Utils_Tuple2(
			36,
			_List_fromArray(
				[13, 27, 32, 35, 38, 41, 49, 70, 78, 83, 90, 131])),
			_Utils_Tuple2(
			37,
			_List_fromArray(
				[38])),
			...
			39,
			_List_fromArray(
				[1, 52, 64, 68, 72, 76, 131])),
			_Utils_Tuple2(
			40,
			_List_fromArray(
				[1, 2, 10, 21, 22, 26, 33, 34, 38, 46, 47, 52, 72, 73, 76, 82, 83, 84, 86, 95, 96, 112, 125, 126, 131])),
			_Utils_Tuple2(
			41,
			_List_fromArray(
				[12, 13, 27, 38])),
			...
			42,
			_List_fromArray(
				[9, 13, 33, 38, 41, 44, 45, 49, 61, 62, 76, 90, 97, 101, 114, 117, 124, 125])),
			_Utils_Tuple2(
			43,
			_List_fromArray(
				[41, 90])),
			...
			47,
			_List_fromArray(
				[1, 18, 21, 23, 28, 33, 38, 44, 46, 52, 76, 78, 81, 82, 99, 117, 128])),
			_Utils_Tuple2(
			48,
			_List_fromArray(
				[85])),
			...
			50,
			_List_fromArray(
				[3, 18, 22, 23, 24, 28, 33, 42, 46, 47, 80, 81, 82, 85, 89, 102, 111, 128])),
			_Utils_Tuple2(
			51,
			_List_fromArray(
				[22, 38])),
			...
			53,
			_List_fromArray(
				[2, 7, 24, 26, 29, 33, 37, 44, 49, 57, 59, 61, 63, 66, 72, 74, 76, 81, 83, 85, 86, 88, 89, 90, 93, 99, 102, 107, 108, 111, 112, 114, 117, 122, 125, 130])),
			_Utils_Tuple2(
			54,
			_List_fromArray(
				[1, 2, 3, 12, 13, 18, 21, 22, 24, 26, 27, 28, 33, 36, 38, 44, 62, 67, 68, 72, 78, 81, 82, 83, 88, 107, 114, 117, 124, 125, 127, 129])),
			_Utils_Tuple2(
			55,
			_List_fromArray(
				[90])),
			...
			58,
			_List_fromArray(
				[1, 2, 13, 21, 22, 27, 28, 32, 33, 38, 44, 45, 61, 68, 70, 72, 75, 76, 78, 83, 93, 102, 103, 114, 117, 124, 125, 127, 129, 131])),
			_Utils_Tuple2(
			59,
			_List_fromArray(
				[90])),
			...
			60,
			_List_fromArray(
				[10, 22, 45, 70, 78, 83, 117, 125, 127, 129])),
			_Utils_Tuple2(
			61,
			_List_fromArray(
				[22, 40, 41, 45, 61, 117, 123, 125, 127, 129])),
			_Utils_Tuple2(
			62,
			_List_fromArray(
				[1, 2, 10, 12, 13, 18, 21, 22, 24, 27, 28, 33, 35, 38, 41, 45, 46, 49, 56, 61, 64, 70, 72, 78, 81, 82, 83, 86, 102, 107, 109, 117, 125, 127, 129, 131, 133])),
			_Utils_Tuple2(
			63,
			_List_fromArray(
				[1, 12, 22, 33, 38, 45, 68, 72, 76, 78, 83, 93, 96, 114, 117, 122, 124, 125, 127, 131])),
			_Utils_Tuple2(
			64,
			_List_fromArray(
				[1, 2, 12, 21, 22, 23, 26, 27, 28, 34, 38, 41, 45, 46, 52, 72, 78, 82, 84, 86, 88, 96, 117, 125, 131])),
			_Utils_Tuple2(
			65,
			_List_fromArray(
				[36])),
			...
			66,
			_List_fromArray(
				[1, 3, 10, 13, 18, 21, 22, 23, 24, 28, 33, 38, 44, 46, 47, 49, 61, 63, 76, 81, 82, 109, 111, 114, 116, 117, 125, 127])),
			_Utils_Tuple2(
			67,
			_List_fromArray(
				[1, 2, 7, 12, 13, 17, 18, 22, 24, 27, 32, 33, 34, 35, 38, 41, 44, 45, 46, 49, 51, 52, 56, 61, 64, 68, 70, 72, 74, 76, 78, 81, 82, 83, 93, 96, 108, 112, 114, 117, 124, 125, 126, 127, 129, 131])),
			_Utils_Tuple2(
			68,
			_List_fromArray(
				[107])),
			...
			70,
			_List_fromArray(
				[1, 2, 22, 26, 27, 33, 36, 38, 40, 41, 44, 45, 47, 52, 68, 70, 72, 76, 78, 83, 86, 88, 90, 102, 104, 114, 117, 122, 124, 125, 127, 131])),
			_Utils_Tuple2(
			71,
			_List_fromArray(
				[130])),
			...
			77,
			_List_fromArray(
				[1, 8, 12, 13, 21, 22, 27, 28, 33, 38, 41, 44, 45, 56, 60, 61, 64, 66, 70, 72, 74, 75, 76, 78, 81, 83, 96, 108, 109, 111, 114, 117, 125, 127, 129])),
			_Utils_Tuple2(
			78,
			_List_fromArray(
				[1, 2, 9, 12, 18, 21, 33, 34, 44, 45, 49, 61, 62, 63, 72, 76, 78, 82, 83, 89, 90, 102, 108, 113, 114, 117, 125, 127, 129, 131])),
			_Utils_Tuple2(
			79,
			_List_fromArray(
				[22, 32, 76])),
			...
			84,
			_List_fromArray(
				[1, 18, 22, 24, 33, 37, 41, 44, 46, 49, 52, 58, 61, 63, 66, 72, 74, 76, 78, 81, 82, 83, 85, 89, 99, 111, 114, 117])),
			_Utils_Tuple2(
			85,
			_List_fromArray(
				[1, 2, 3, 5, 7, 12, 23, 24, 26, 28, 33, 37, 44, 46, 49, 52, 57, 61, 63, 66, 68, 72, 76, 81, 82, 85, 88, 90, 107, 109, 111, 114, 117, 124, 125, 126])),
			_Utils_Tuple2(
			86,
			_List_fromArray(
				[12, 22, 27, 38, 78, 83])),
			...
			87,
			_List_fromArray(
				[22, 38, 52, 66, 76, 78, 83, 123])),
			_Utils_Tuple2(
			88,
			_List_fromArray(
				[19, 27, 35, 36, 41, 45, 61, 70, 72, 75, 76, 117, 125, 127, 129])),
			_Utils_Tuple2(
			89,
			_List_fromArray(
				[41])),
			...
			92,
			_List_fromArray(
				[1, 22, 27, 29, 33, 41, 42, 44, 49, 52, 61, 63, 72, 76, 78, 81, 83, 89, 90, 99, 108, 109, 114, 117, 125])),
			_Utils_Tuple2(
			93,
			_List_fromArray(
				[90])),
			...
			97,
			_List_fromArray(
				[1, 2, 12, 13, 18, 21, 22, 24, 26, 27, 33, 34, 35, 38, 44, 45, 46, 49, 52, 53, 61, 68, 70, 72, 76, 78, 81, 82, 83, 84, 86, 88, 93, 96, 99, 102, 109, 112, 117, 124, 125, 126, 127, 129, 131])),
			_Utils_Tuple2(
			98,
			_List_fromArray(
				[22, 27, 32, 38, 70, 72, 76, 78, 83, 90, 103, 124, 125, 127, 131])),
			_Utils_Tuple2(
			99,
			_List_fromArray(
				[90])),
			...
			101,
			_List_fromArray(
				[22, 41, 45, 72, 93, 102, 117, 127, 129])),
			_Utils_Tuple2(
			102,
			_List_fromArray(
				[130])),
			...
			104,
			_List_fromArray(
				[2, 22, 27, 32, 33, 38, 45, 56, 70, 72, 83, 98, 117, 125, 127])),
			_Utils_Tuple2(
			105,
			_List_fromArray(
				[45, 127, 129])),
			...
			106,
			_List_fromArray(
				[1, 2, 3, 6, 18, 22, 23, 28, 29, 33, 44, 48, 52, 58, 61, 63, 65, 72, 75, 81, 82, 83, 85, 86, 89, 109, 111, 114, 117, 125, 127, 133])),
			_Utils_Tuple2(
			107,
			_List_fromArray(
				[2, 22, 23, 26, 33, 38, 45, 46, 56, 61, 72, 82, 86, 117, 124, 125, 127])),
			_Utils_Tuple2(
			108,
			_List_fromArray(
				[31])),
			...
			112,
			_List_fromArray(
				[1, 9, 44, 52, 61, 63, 72, 76, 81, 108, 114, 128])),
			_Utils_Tuple2(
			113,
			_List_fromArray(
				[38])),
			...
			115,
			_List_fromArray(
				[1, 2, 18, 22, 28, 29, 30, 33, 34, 35, 38, 44, 45, 47, 49, 51, 60, 61, 65, 72, 75, 81, 86, 96, 98, 99, 101, 102, 103, 108, 109, 110, 111, 114, 117, 122, 123, 124, 125, 128])),
			_Utils_Tuple2(
			116,
			_List_fromArray(
				[1, 2, 12, 13, 22, 33, 38, 72, 76, 82, 88, 107, 124, 125, 131])),
			_Utils_Tuple2(
			117,
			_List_fromArray(
				[90])),
			...
			120,
			_List_fromArray(
				[4, 9, 15, 39, 44, 61, 72, 76, 114])),
			_Utils_Tuple2(
			121,
			_List_fromArray(
				[1, 3, 12, 18, 22, 23, 24, 28, 30, 33, 44, 46, 52, 57, 59, 66, 76, 78, 81, 82, 89, 96, 107, 111, 114, 117, 122, 125, 127])),
			_Utils_Tuple2(
			122,
			_List_fromArray(
				[1, 18, 22, 23, 24, 28, 29, 30, 33, 35, 37, 41, 42, 44, 45, 46, 48, 49, 52, 61, 63, 72, 76, 80, 81, 82, 85, 89, 90, 92, 99, 102, 107, 108, 109, 111, 112, 114, 117, 122, 125, 127, 130])),
			_Utils_Tuple2(
			123,
			_List_fromArray(
				[2, 17, 22, 27, 28, 33, 38, 117, 127])),
			_Utils_Tuple2(
			124,
			_List_fromArray(
				[1, 2, 17, 22, 23, 24, 33, 34, 68, 72, 86, 95, 96, 102, 107, 112, 114, 117, 124, 125])),
			_Utils_Tuple2(
			125,
			_List_fromArray(
				[22, 49, 72, 85, 114, 117])),
			...
			127,
			_List_fromArray(
				[2, 25, 27, 34, 41, 45, 84, 127, 129])),
			_Utils_Tuple2(
			128,
			_List_fromArray(
				[1, 2, 6, 18, 22, 24, 33, 35, 41, 44, 45, 51, 52, 61, 62, 63, 72, 75, 76, 78, 81, 83, 85, 87, 89, 99, 102, 107, 108, 109, 114, 117])),
			_Utils_Tuple2(
			129,
			_List_fromArray(
				[1, 2, 33, 41, 44, 52, 61, 72, 75, 76, 78, 99, 101, 102, 108, 114, 117, 125, 127])),
			_Utils_Tuple2(
			130,
			_List_fromArray(
				[1, 7, 12, 22, 24, 25, 27, 33, 34, 38, 41, 45, 46, 48, 52, 61, 70, 72, 75, 76, 78, 82, 88, 89, 90, 92, 98, 101, 102, 103, 105, 106, 107, 117, 124, 125, 126, 127, 131])),
			_Utils_Tuple2(
			131,
			_List_fromArray(
				[1, 2, 22, 23, 24, 33, 41, 42, 43, 44, 45, 49, 52, 61, 63, 72, 76, 78, 82, 89, 90, 108, 109, 111, 114, 117, 124, 125, 127, 129, 133])),
			_Utils_Tuple2(
			132,
			_List_fromArray(
				[1, 9, 12, 18, 22, 24, 27, 29, 33, 38, 41, 44, 49, 52, 56, 57, 61, 70, 72, 74, 76, 78, 81, 90, 108, 111, 114, 117, 124, 125, 127])),
			_Utils_Tuple2(
			133,
			_List_fromArray(
				[1, 13, 18, 22, 33, 38, 44, 48, 49, 52, 61, 63, 72, 74, 78, 81, 82, 83, 85, 102, 108, 110, 111, 114, 117, 125])),
			_Utils_Tuple2(
			134,
			_List_fromArray(
				[72])),
			...
			135,
			_List_fromArray(
				[1, 2, 3, 7, 13, 15, 18, 22, 23, 24, 25, 26, 27, 28, 29, 33, 37, 38, 41, 42, 44, 45, 46, 49, 52, 55, 57, 59, 61, 62, 63, 66, 70, 72, 74, 75, 76, 78, 81, 82, 83, 84, 85, 88, 89, 90, 93, 102, 108, 109, 111, 114, 116, 117, 122, 124, 125, 127, 130])),
			_Utils_Tuple2(
			136,
			_List_fromArray(
				[3, 6, 7, 11, 18, 24, 33, 42, 44, 49, 52, 61, 63, 72, 76, 78, 81, 82, 83, 85, 89, 111, 112, 114, 117, 125])),
			_Utils_Tuple2(
			137,
			_List_fromArray(
				[1, 3, 7, 12, 18, 22, 24, 28, 33, 34, 37, 42, 44, 46, 49, 52, 61, 63, 66, 72, 75, 78, 81, 82, 83, 84, 85, 89, 90, 92, 96, 108, 109, 111, 113, 114, 116, 117, 125, 126, 132])),
			_Utils_Tuple2(
			138,
			_List_fromArray(
				[1, 2, 3, 6, 9, 15, 18, 22, 23, 24, 26, 28, 29, 33, 37, 42, 44, 46, 48, 51, 52, 59, 63, 66, 68, 72, 74, 76, 78, 79, 81, 82, 85, 86, 88, 89, 95, 96, 102, 106, 107, 108, 109, 111, 113, 114, 115, 117, 125, 128, 131])),
			_Utils_Tuple2(
			139,
			_List_fromArray(
				[1, 5, 13, 18, 21, 22, 24, 27, 29, 33, 38, 41, 44, 46, 48, 49, 52, 61, 63, 72, 75, 76, 78, 81, 93, 102, 107, 108, 109, 114, 117, 129, 133])),
			_Utils_Tuple2(
			140,
			_List_fromArray(
				[1, 3, 12, 15, 17, 18, 23, 24, 28, 33, 37, 44, 45, 46, 48, 49, 57, 58, 59, 61, 63, 66, 70, 71, 72, 74, 75, 76, 80, 81, 82, 85, 89, 90, 99, 102, 108, 109, 111, 113, 114, 116, 117, 125])),
			_Utils_Tuple2(
			141,
			_List_fromArray(
				[1, 2, 3, 23, 24, 26, 28, 33, 41, 44, 46, 52, 72, 75, 76, 81, 82, 88, 89, 90, 93, 102, 111, 114, 117, 125, 131, 132])),
			_Utils_Tuple2(
			142,
			_List_fromArray(
				[1, 18, 22, 24, 29, 33, 39, 41, 44, 47, 49, 52, 57, 61, 66, 72, 75, 76, 81, 82, 85, 89, 94, 99, 102, 108, 111, 114, 117, 123, 125, 128])),
			_Utils_Tuple2(
			143,
			_List_fromArray(
				[1, 2, 22, 28, 33, 38, 72, 83, 86, 88, 90, 92, 117, 125, 131])),
			_Utils_Tuple2(
			144,
			_List_fromArray(
				[1, 12, 13, 18, 21, 22, 27, 33, 38, 48, 52, 61, 70, 72, 75, 76, 78, 83, 90, 93, 98, 114, 117, 118, 125, 131])),
			_Utils_Tuple2(
			145,
			_List_fromArray(
				[36, 90])),
			...
			146,
			_List_fromArray(
				[22, 52, 70, 76, 78, 83, 127, 131])),
			_Utils_Tuple2(
			147,
			_List_fromArray(
				[22, 41, 45, 54, 60, 78, 127, 131])),
			_Utils_Tuple2(
			148,
			_List_fromArray(
				[7, 9, 12, 13, 18, 22, 23, 24, 28, 29, 33, 44, 45, 46, 52, 57, 59, 61, 62, 63, 66, 72, 74, 75, 76, 81, 82, 85, 89, 99, 102, 106, 107, 108, 111, 113, 114, 117, 121, 123, 128])),
			_Utils_Tuple2(
			149,
			_List_fromArray(
				[21, 28, 76])),
			...
			151,
			_List_fromArray(
				[12, 13, 22, 27, 38, 41, 70, 78, 98])),
			_Utils_Tuple2(
			152,
			_List_fromArray(
				[1, 7, 9, 23, 42, 44, 49, 52, 61, 72, 76, 82, 85, 109, 114, 117, 125, 129, 133])),
			_Utils_Tuple2(
			153,
			_List_fromArray(
				[22, 32, 33, 38, 117, 125, 127])),
			_Utils_Tuple2(
			154,
			_List_fromArray(
				[1, 2, 18, 22, 33, 38, 45, 72, 83, 86, 88, 117, 122, 124, 125, 127, 129, 131])),
			_Utils_Tuple2(
			155,
			_List_fromArray(
				[1, 2, 10, 12, 13, 22, 24, 27, 28, 33, 38, 45, 48, 52, 72, 75, 78, 82, 83, 102, 107, 108, 109, 112, 117, 122, 125, 127, 129, 131])),
			_Utils_Tuple2(
			156,
			_List_fromArray(
				[1, 3, 7, 9, 18, 24, 27, 28, 33, 37, 41, 42, 44, 46, 49, 52, 57, 59, 61, 62, 66, 69, 72, 76, 81, 82, 85, 89, 102, 109, 111, 114, 117, 121, 122, 125, 132, 133])),
			_Utils_Tuple2(
			157,
			_List_fromArray(
				[85])),
			...
			158,
			_List_fromArray(
				[1, 2, 10, 15, 18, 21, 22, 27, 32, 33, 34, 38, 41, 48, 56, 61, 70, 72, 76, 78, 82, 86, 88, 90, 107, 117, 122, 124, 125, 127, 131])),
			_Utils_Tuple2(
			159,
			_List_fromArray(
				[1, 2, 8, 22, 38, 45, 61, 70, 72, 75, 76, 78, 81, 86, 102, 109, 117, 125, 127, 129, 131])),
			_Utils_Tuple2(
			160,
			_List_fromArray(
				[1, 2, 7, 22, 27, 33, 34, 35, 38, 42, 45, 46, 56, 61, 70, 72, 76, 78, 82, 83, 84, 92, 109, 117, 124, 125, 127, 129, 131, 133])),
			_Utils_Tuple2(
			161,
			_List_fromArray(
				[1, 2, 13, 22, 26, 28, 33, 37, 38, 44, 45, 49, 61, 72, 82, 85, 86, 102, 114, 117, 129])),
			_Utils_Tuple2(
			162,
			_List_fromArray(
				[1, 9, 10, 11, 18, 22, 24, 29, 33, 42, 44, 47, 52, 61, 63, 72, 74, 75, 76, 81, 90, 96, 97, 99, 102, 108, 109, 111, 114, 117, 125, 127, 129, 130])),
			_Utils_Tuple2(
			163,
			_List_fromArray(
				[1, 12, 28, 33, 38, 45, 50, 72, 76, 83, 102, 112, 117, 124, 125, 127])),
			_Utils_Tuple2(
			164,
			_List_fromArray(
				[1, 7, 9, 12, 13, 14, 15, 18, 22, 23, 24, 28, 29, 33, 38, 42, 44, 45, 46, 52, 57, 59, 61, 62, 63, 66, 72, 74, 75, 76, 81, 82, 85, 89, 98, 99, 102, 108, 109, 111, 114, 117, 125, 128, 129, 130, 132, 133])),
			_Utils_Tuple2(
			165,
			_List_fromArray(
				[1, 9, 11, 18, 28, 29, 30, 33, 41, 43, 44, 46, 49, 61, 62, 63, 72, 76, 78, 81, 82, 84, 85, 99, 101, 102, 108, 109, 111, 114, 117, 125, 127, 130, 133])),
			_Utils_Tuple2(
			166,
			_List_fromArray(
				[1, 3, 7, 16, 17, 22, 24, 27, 29, 33, 37, 41, 42, 44, 46, 48, 52, 57, 58, 61, 62, 63, 66, 68, 72, 75, 76, 81, 82, 85, 87, 89, 90, 102, 108, 109, 111, 114, 117, 125, 128, 129, 132, 133])),
			_Utils_Tuple2(
			167,
			_List_fromArray(
				[27, 32, 38, 45, 70, 72, 76, 78, 83, 117, 125, 127, 129, 131])),
			_Utils_Tuple2(
			168,
			_List_fromArray(
				[1, 2, 22, 27, 33, 38, 44, 45, 52, 68, 72, 76, 78, 81, 83, 86, 88, 99, 102, 114, 117, 125, 129, 131])),
			_Utils_Tuple2(
			169,
			_List_fromArray(
				[1, 2, 3, 22, 27, 30, 33, 38, 44, 45, 52, 61, 72, 73, 75, 76, 78, 81, 82, 84, 86, 88, 90, 93, 102, 107, 117, 124, 127, 129, 131])),
			_Utils_Tuple2(
			170,
			_List_fromArray(
				[1, 2, 18, 24, 33, 42, 44, 49, 52, 61, 63, 72, 76, 78, 81, 85, 102, 107, 108, 112, 114, 117, 125])),
			_Utils_Tuple2(
			171,
			_List_fromArray(
				[1, 2, 8, 13, 18, 22, 32, 33, 38, 41, 49, 52, 56, 61, 70, 72, 76, 78, 82, 83, 102, 114, 117, 125, 127, 131])),
			_Utils_Tuple2(
			172,
			_List_fromArray(
				[1, 5, 11, 12, 13, 18, 22, 23, 24, 28, 29, 30, 33, 37, 44, 46, 49, 57, 59, 61, 63, 66, 72, 75, 76, 77, 78, 81, 82, 83, 85, 90, 93, 102, 107, 108, 109, 113, 114, 117, 125, 133])),
			_Utils_Tuple2(
			173,
			_List_fromArray(
				[1, 2, 13, 22, 33, 34, 38, 41, 45, 72, 76, 78, 86, 88, 117, 125, 127, 129, 131])),
			_Utils_Tuple2(
			174,
			_List_fromArray(
				[1, 2, 12, 13, 18, 21, 22, 24, 26, 27, 28, 33, 38, 46, 49, 61, 70, 72, 82, 86, 88, 109, 112, 117, 124, 125, 127, 129])),
			_Utils_Tuple2(
			175,
			_List_fromArray(
				[1, 2, 6, 7, 12, 14, 15, 18, 20, 21, 22, 23, 24, 28, 33, 35, 44, 46, 49, 51, 52, 57, 61, 63, 66, 67, 72, 76, 81, 82, 85, 86, 88, 89, 90, 93, 99, 102, 107, 108, 109, 111, 112, 114, 116, 117, 125, 130, 132, 133])),
			_Utils_Tuple2(
			176,
			_List_fromArray(
				[1, 2, 7, 12, 18, 21, 22, 26, 27, 28, 33, 34, 37, 38, 41, 42, 43, 44, 45, 46, 49, 51, 61, 72, 76, 77, 78, 81, 82, 85, 86, 88, 95, 102, 109, 112, 114, 117, 125, 129, 131])),
			_Utils_Tuple2(
			177,
			_List_fromArray(
				[1, 2, 7, 12, 21, 22, 23, 27, 28, 33, 35, 38, 41, 42, 44, 45, 46, 48, 52, 61, 63, 64, 68, 70, 72, 75, 76, 78, 81, 82, 83, 84, 89, 92, 99, 102, 107, 109, 111, 114, 117, 124, 125, 127, 131])),
			_Utils_Tuple2(
			178,
			_List_fromArray(
				[1, 2, 3, 12, 21, 22, 26, 27, 28, 31, 33, 34, 35, 38, 41, 46, 48, 49, 52, 70, 72, 82, 83, 84, 86, 88, 90, 102, 112, 117, 122, 124, 125, 127, 133])),
			_Utils_Tuple2(
			179,
			_List_fromArray(
				[1, 3, 18, 21, 22, 27, 28, 31, 33, 34, 38, 40, 41, 45, 56, 72, 78, 83, 86, 90, 92, 117, 125, 127, 129])),
			_Utils_Tuple2(
			180,
			_List_fromArray(
				[1, 2, 3, 11, 13, 18, 22, 24, 26, 28, 33, 34, 38, 42, 44, 45, 46, 51, 52, 57, 61, 63, 66, 72, 75, 76, 78, 81, 82, 83, 85, 86, 90, 96, 108, 109, 111, 114, 117, 125])),
			_Utils_Tuple2(
			181,
			_List_fromArray(
				[4, 9, 18, 22, 24, 33, 44, 49, 57, 61, 62, 63, 66, 81, 85, 108, 109, 111, 114, 117])),
			_Utils_Tuple2(
			182,
			_List_fromArray(
				[102, 127, 129])),
			...
			183,
			_List_fromArray(
				[1, 2, 18, 22, 33, 52, 61, 70, 72, 75, 78, 83, 86, 108, 114, 117, 125, 127, 129])),
			_Utils_Tuple2(
			184,
			_List_fromArray(
				[1, 12, 22, 23, 24, 28, 33, 44, 45, 46, 49, 52, 57, 61, 64, 70, 72, 76, 78, 81, 82, 87, 91, 97, 106, 107, 111, 114, 116, 117, 124, 129])),
			_Utils_Tuple2(
			185,
			_List_fromArray(
				[2, 84, 117, 125])),
			...
			186,
			_List_fromArray(
				[1, 18, 22, 27, 33, 38, 49, 60, 70, 72, 82, 83, 107, 117, 125, 127, 129, 131])),
			_Utils_Tuple2(
			187,
			_List_fromArray(
				[1, 6, 9, 14, 22, 24, 33, 39, 41, 44, 46, 49, 52, 61, 63, 72, 76, 78, 81, 82, 83, 89, 90, 102, 108, 111, 114, 117, 124, 125, 133])),
			_Utils_Tuple2(
			188,
			_List_fromArray(
				[1, 12, 13, 21, 22, 25, 27, 28, 33, 34, 38, 44, 45, 47, 49, 52, 57, 61, 64, 67, 68, 72, 76, 78, 82, 83, 84, 93, 100, 102, 109, 112, 114, 117, 118, 122, 124, 125, 126, 127, 131])),
			_Utils_Tuple2(
			189,
			_List_fromArray(
				[27, 38, 41, 45, 60, 76, 82, 127, 129, 131])),
			_Utils_Tuple2(
			190,
			_List_fromArray(
				[11, 35, 41, 45, 61, 72, 75, 76, 78, 83, 117, 124, 125, 127, 129])),
			_Utils_Tuple2(
			191,
			_List_fromArray(
				[1, 2, 18, 22, 25, 33, 38, 41, 45, 49, 56, 60, 61, 72, 76, 83, 86, 89, 90, 107, 117, 122, 123, 127, 129])),
			_Utils_Tuple2(
			192,
			_List_fromArray(
				[2, 18, 22, 33, 35, 38, 41, 45, 61, 63, 75, 83, 117, 125, 127, 129])),
			_Utils_Tuple2(
			193,
			_List_fromArray(
				[2, 11, 18, 24, 27, 33, 41, 44, 45, 46, 49, 58, 61, 62, 72, 74, 76, 81, 87, 89, 90, 108, 109, 111, 114, 117, 122, 125])),
			_Utils_Tuple2(
			194,
			_List_fromArray(
				[12, 13, 27, 38, 41, 67, 70, 76, 78, 83, 118])),
			_Utils_Tuple2(
			195,
			_List_fromArray(
				[45, 61, 90])),
			...
			196,
			_List_fromArray(
				[1, 2, 3, 12, 13, 21, 22, 26, 27, 33, 34, 38, 41, 43, 44, 45, 46, 49, 52, 61, 63, 68, 70, 72, 76, 78, 82, 83, 84, 86, 96, 102, 112, 113, 114, 117, 125, 129])),
			_Utils_Tuple2(
			197,
			_List_fromArray(
				[1, 2, 22, 25, 28, 33, 41, 68, 72, 82, 86, 88, 90, 102, 114, 117, 124, 125, 127, 129, 131])),
			_Utils_Tuple2(
			198,
			_List_fromArray(
				[41])),
			...
			203,
			_List_fromArray(
				[34, 38, 45, 48, 61, 74, 75, 76, 83, 117, 123, 125, 127, 129, 130]))
		]));
var $author$project$Data$uniCodes = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(1, 'ACM Guildford Limited'),
			_Utils_Tuple2(2, 'AECC University College'),
			_Utils_Tuple2(3, 'ALRA'),
			_Utils_Tuple2(4, 'Aberystwyth University'),
			_Utils_Tuple2(5, 'Anglia Ruskin University Higher Corporation'),
			_Utils_Tuple2(6, 'Architectural Association (Incorporated)'),
			_Utils_Tuple2(7, 'Arden University Limited'),
			_Utils_Tuple2(8, 'Arts Educational Schools(The)'),
			_Utils_Tuple2(9, 'Arts University Bournemouth, the'),
			_Utils_Tuple2(10, 'Aston University'),
			_Utils_Tuple2(11, 'BIMM Limited'),
			_Utils_Tuple2(12, 'BPP University Limited'),
			_Utils_Tuple2(13, 'Bangor University'),
			_Utils_Tuple2(14, 'Bath Spa University'),
			_Utils_Tuple2(15, 'Birkbeck College'),
			_Utils_Tuple2(16, 'Birmingham City University'),
			_Utils_Tuple2(17, 'Bishop Grosseteste University'),
			_Utils_Tuple2(18, 'Blackpool and the Fylde College'),
			_Utils_Tuple2(19, 'Bloomsbury Institute Limited'),
			_Utils_Tuple2(20, 'Bournemouth University'),
			_Utils_Tuple2(21, 'Bradford College'),
			_Utils_Tuple2(22, 'Brighton and Sussex Medical School'),
			_Utils_Tuple2(23, 'Brunel University London'),
			_Utils_Tuple2(24, 'Buckinghamshire New University'),
			_Utils_Tuple2(25, 'Canterbury Christ Church University'),
			_Utils_Tuple2(26, 'Cardiff Metropolitan University'),
			_Utils_Tuple2(27, 'Cardiff University'),
			_Utils_Tuple2(28, 'City, University of London'),
			_Utils_Tuple2(29, 'Courtauld Institute of Art'),
			_Utils_Tuple2(30, 'Coventry University'),
			_Utils_Tuple2(31, 'De Montfort University'),
			_Utils_Tuple2(32, 'Deep Blue Sound Limited'),
			_Utils_Tuple2(33, 'Doreen Bird College of Performing Arts Ltd.'),
			_Utils_Tuple2(34, 'Edge Hill University'),
			_Utils_Tuple2(35, 'Edinburgh Napier University'),
			_Utils_Tuple2(36, 'Falmouth University'),
			_Utils_Tuple2(37, 'Fashion Retail Academy'),
			_Utils_Tuple2(38, 'Futureworks Training Limited'),
			_Utils_Tuple2(39, 'GSM London Limited'),
			_Utils_Tuple2(40, 'Glasgow Caledonian University'),
			_Utils_Tuple2(41, 'Glasgow School of Art.'),
			_Utils_Tuple2(42, 'Goldsmiths\' College'),
			_Utils_Tuple2(43, 'Guildhall School of Music & Drama'),
			_Utils_Tuple2(44, 'Harper Adams University'),
			_Utils_Tuple2(45, 'Hartpury University'),
			_Utils_Tuple2(46, 'Hereford College of Arts'),
			_Utils_Tuple2(47, 'Heriot-Watt University'),
			_Utils_Tuple2(48, 'Hull and York Medical School'),
			_Utils_Tuple2(49, 'ICMP Management Limited'),
			_Utils_Tuple2(50, 'Imperial College of Science, Technology and Medicine'),
			_Utils_Tuple2(51, 'Istituto Marangoni Limited'),
			_Utils_Tuple2(52, 'Kaplan Open Learning (Essex) Limited'),
			_Utils_Tuple2(53, 'King\'s College London'),
			_Utils_Tuple2(54, 'Kingston University'),
			_Utils_Tuple2(55, 'LCCM AU UK Limited'),
			_Utils_Tuple2(56, 'LTE Group'),
			_Utils_Tuple2(57, 'Leeds Arts University'),
			_Utils_Tuple2(58, 'Leeds Beckett University'),
			_Utils_Tuple2(59, 'Leeds College of Music'),
			_Utils_Tuple2(60, 'Leeds Trinity University'),
			_Utils_Tuple2(61, 'Liverpool Hope University'),
			_Utils_Tuple2(62, 'Liverpool John Moores University'),
			_Utils_Tuple2(63, 'London Metropolitan University'),
			_Utils_Tuple2(64, 'London South Bank University'),
			_Utils_Tuple2(65, 'London Studio Centre Limited'),
			_Utils_Tuple2(66, 'Loughborough University'),
			_Utils_Tuple2(67, 'Manchester Metropolitan University'),
			_Utils_Tuple2(68, 'Medway School of Pharmacy'),
			_Utils_Tuple2(69, 'Met Film School Limited'),
			_Utils_Tuple2(70, 'Middlesex University'),
			_Utils_Tuple2(71, 'Moorlands College'),
			_Utils_Tuple2(72, 'Mountview Academy of Theatre Arts Limited'),
			_Utils_Tuple2(73, 'Newham College of Further Education'),
			_Utils_Tuple2(74, 'Newman University'),
			_Utils_Tuple2(75, 'Norland College Limited'),
			_Utils_Tuple2(76, 'Norwich University of the Arts'),
			_Utils_Tuple2(77, 'Nottingham Trent University'),
			_Utils_Tuple2(78, 'Oxford Brookes University'),
			_Utils_Tuple2(79, 'Pearson College Limited'),
			_Utils_Tuple2(80, 'Plymouth College of Art'),
			_Utils_Tuple2(81, 'Point Blank Limited'),
			_Utils_Tuple2(82, 'QAHE (UR) Limited'),
			_Utils_Tuple2(83, 'Queen Margaret University, Edinburgh'),
			_Utils_Tuple2(84, 'Queen Mary University of London'),
			_Utils_Tuple2(85, 'Queen\'s University of Belfast'),
			_Utils_Tuple2(86, 'Ravensbourne University London'),
			_Utils_Tuple2(87, 'Regent\'s University London'),
			_Utils_Tuple2(88, 'Roehampton University'),
			_Utils_Tuple2(89, 'Rose Bruford College of Theatre and Performance'),
			_Utils_Tuple2(90, 'Royal College of Music'),
			_Utils_Tuple2(91, 'Royal Conservatoire of Scotland'),
			_Utils_Tuple2(92, 'Royal Holloway and Bedford New College'),
			_Utils_Tuple2(93, 'Royal Northern College of Music'),
			_Utils_Tuple2(94, 'Royal Welsh College of Music and Drama'),
			_Utils_Tuple2(95, 'SAE Education Limited'),
			_Utils_Tuple2(96, 'SRUC'),
			_Utils_Tuple2(97, 'Sheffield Hallam University'),
			_Utils_Tuple2(98, 'Solent University'),
			_Utils_Tuple2(99, 'Spirit SSR Limited'),
			_Utils_Tuple2(100, 'St Mary\'s University College'),
			_Utils_Tuple2(101, 'St Mary\'s University, Twickenham'),
			_Utils_Tuple2(102, 'St Mellitus College Trust'),
			_Utils_Tuple2(103, 'St. George\'s Hospital Medical School'),
			_Utils_Tuple2(104, 'Staffordshire University'),
			_Utils_Tuple2(105, 'Stranmillis University College'),
			_Utils_Tuple2(106, 'Swansea University'),
			_Utils_Tuple2(107, 'Teesside University'),
			_Utils_Tuple2(108, 'The College of Osteopaths'),
			_Utils_Tuple2(109, 'The Conservatoire for Dance and Drama'),
			_Utils_Tuple2(110, 'The Interactive Design Institute Limited'),
			_Utils_Tuple2(111, 'The Liverpool Institute for Performing Arts'),
			_Utils_Tuple2(112, 'The London School of Economics and Political Science'),
			_Utils_Tuple2(113, 'The Northern School of Art'),
			_Utils_Tuple2(114, 'The Oldham College'),
			_Utils_Tuple2(115, 'The Open University'),
			_Utils_Tuple2(116, 'The Robert Gordon University'),
			_Utils_Tuple2(117, 'The Royal Academy of Music'),
			_Utils_Tuple2(118, 'The Royal Agricultural University'),
			_Utils_Tuple2(119, 'The Royal Veterinary College'),
			_Utils_Tuple2(120, 'The School of Oriental and African Studies'),
			_Utils_Tuple2(121, 'The University of Bath'),
			_Utils_Tuple2(122, 'The University of Birmingham'),
			_Utils_Tuple2(123, 'The University of Bolton'),
			_Utils_Tuple2(124, 'The University of Bradford'),
			_Utils_Tuple2(125, 'The University of Buckingham'),
			_Utils_Tuple2(126, 'The University of Chichester'),
			_Utils_Tuple2(127, 'The University of Cumbria'),
			_Utils_Tuple2(128, 'The University of East Anglia'),
			_Utils_Tuple2(129, 'The University of Essex'),
			_Utils_Tuple2(130, 'The University of Huddersfield'),
			_Utils_Tuple2(131, 'The University of Hull'),
			_Utils_Tuple2(132, 'The University of Kent'),
			_Utils_Tuple2(133, 'The University of Lancaster'),
			_Utils_Tuple2(134, 'The University of Law Limited'),
			_Utils_Tuple2(135, 'The University of Leeds'),
			_Utils_Tuple2(136, 'The University of Leicester'),
			_Utils_Tuple2(137, 'The University of Liverpool'),
			_Utils_Tuple2(138, 'The University of Manchester'),
			_Utils_Tuple2(139, 'The University of Reading'),
			_Utils_Tuple2(140, 'The University of Sheffield'),
			_Utils_Tuple2(141, 'The University of Surrey'),
			_Utils_Tuple2(142, 'The University of Warwick'),
			_Utils_Tuple2(143, 'The University of West London'),
			_Utils_Tuple2(144, 'The University of Westminster'),
			_Utils_Tuple2(145, 'Trinity Laban Conservatoire of Music and Dance'),
			_Utils_Tuple2(146, 'UCFB College of Football Business Limited'),
			_Utils_Tuple2(147, 'University College Birmingham'),
			_Utils_Tuple2(148, 'University College London'),
			_Utils_Tuple2(149, 'University College of Estate Management'),
			_Utils_Tuple2(150, 'University College of Osteopathy (The)'),
			_Utils_Tuple2(151, 'University for the Creative Arts'),
			_Utils_Tuple2(152, 'University of Aberdeen'),
			_Utils_Tuple2(153, 'University of Abertay Dundee'),
			_Utils_Tuple2(154, 'University of Bedfordshire'),
			_Utils_Tuple2(155, 'University of Brighton'),
			_Utils_Tuple2(156, 'University of Bristol'),
			_Utils_Tuple2(157, 'University of Cambridge'),
			_Utils_Tuple2(158, 'University of Central Lancashire'),
			_Utils_Tuple2(159, 'University of Chester'),
			_Utils_Tuple2(160, 'University of Derby'),
			_Utils_Tuple2(161, 'University of Dundee'),
			_Utils_Tuple2(162, 'University of Durham'),
			_Utils_Tuple2(163, 'University of East London'),
			_Utils_Tuple2(164, 'University of Edinburgh'),
			_Utils_Tuple2(165, 'University of Exeter'),
			_Utils_Tuple2(166, 'University of Glasgow'),
			_Utils_Tuple2(167, 'University of Gloucestershire'),
			_Utils_Tuple2(168, 'University of Greenwich'),
			_Utils_Tuple2(169, 'University of Hertfordshire'),
			_Utils_Tuple2(170, 'University of Keele'),
			_Utils_Tuple2(171, 'University of Lincoln'),
			_Utils_Tuple2(172, 'University of Newcastle upon Tyne'),
			_Utils_Tuple2(173, 'University of Northampton, The'),
			_Utils_Tuple2(174, 'University of Northumbria at Newcastle'),
			_Utils_Tuple2(175, 'University of Nottingham, The'),
			_Utils_Tuple2(176, 'University of Plymouth'),
			_Utils_Tuple2(177, 'University of Portsmouth'),
			_Utils_Tuple2(178, 'University of Salford, The'),
			_Utils_Tuple2(179, 'University of South Wales'),
			_Utils_Tuple2(180, 'University of Southampton'),
			_Utils_Tuple2(181, 'University of St Andrews'),
			_Utils_Tuple2(182, 'University of St Mark & St John'),
			_Utils_Tuple2(183, 'University of Stirling'),
			_Utils_Tuple2(184, 'University of Strathclyde'),
			_Utils_Tuple2(185, 'University of Suffolk'),
			_Utils_Tuple2(186, 'University of Sunderland'),
			_Utils_Tuple2(187, 'University of Sussex'),
			_Utils_Tuple2(188, 'University of Ulster'),
			_Utils_Tuple2(189, 'University of Wales Trinity Saint David'),
			_Utils_Tuple2(190, 'University of Winchester'),
			_Utils_Tuple2(191, 'University of Wolverhampton'),
			_Utils_Tuple2(192, 'University of Worcester'),
			_Utils_Tuple2(193, 'University of York'),
			_Utils_Tuple2(194, 'University of the Arts, London'),
			_Utils_Tuple2(195, 'University of the Highlands and Islands'),
			_Utils_Tuple2(196, 'University of the West of England, Bristol'),
			_Utils_Tuple2(197, 'University of the West of Scotland'),
			_Utils_Tuple2(198, 'Urdang Schools Limited'),
			_Utils_Tuple2(199, 'Warwickshire College'),
			_Utils_Tuple2(200, 'Wirral Metropolitan College'),
			_Utils_Tuple2(201, 'Wrexham Glyndŵr University'),
			_Utils_Tuple2(202, 'Writtle University College'),
			_Utils_Tuple2(203, 'York St John University')
		]));
var $author$project$Data$unisOffering = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			...
			1,
			_List_fromArray(
				[5, 10, 12, 13, 15, 16, 20, 23, 25, 26, 27, 28, 30, 31, 35, 39, 40, 47, 54, 58, 62, 63, 64, 66, 67, 70, 77, 78, 84, 85, 92, 97, 106, 112, 115, 116, 121, 122, 124, 128, 129, 130, 131, 132, 133, 135, 137, 138, 139, 140, 141, 142, 143, 144, 152, 154, 155, 156, 158, 159, 160, 161, 162, 163, 164, 165, 166, 168, 169, 170, 171, 172, 173, 174, 175, 176, 177, 178, 179, 180, 183, 184, 186, 187, 188, 191, 196, 197])),
			_Utils_Tuple2(
			2,
			_List_fromArray(
				[5, 13, 16, 20, 24, 25, 30, 31, 34, 35, 40, 53, 54, 58, 62, 64, 67, 70, 78, 85, 97, 104, 106, 107, 115, 116, 123, 124, 127, 128, 129, 131, 135, 138, 141, 143, 154, 155, 158, 159, 160, 161, 168, 169, 170, 171, 173, 174, 175, 176, 177, 178, 180, 183, 185, 191, 192, 193, 196, 197])),
			_Utils_Tuple2(
			3,
			_List_fromArray(
				[23, 30, 50, 54, 66, 85, 106, 121, 135, 136, 137, 138, 140, 141, 156, 166, 169, 178, 179, 180, 196])),
			_Utils_Tuple2(
			4,
			_List_fromArray(
				[120, 181])),
			...
			5,
			_List_fromArray(
				[44, 85, 96, 118, 139, 172])),
			_Utils_Tuple2(
			6,
			_List_fromArray(
				[106, 128, 136, 138, 175, 187])),
			_Utils_Tuple2(
			7,
			_List_fromArray(
				[30, 53, 67, 85, 130, 135, 136, 137, 148, 152, 156, 160, 164, 166, 175, 176, 177])),
			_Utils_Tuple2(
			8,
			_List_fromArray(
				[44, 45, 77, 118, 119, 159, 171, 202])),
			_Utils_Tuple2(
			9,
			_List_fromArray(
				[20, 42, 78, 112, 120, 132, 138, 148, 152, 156, 162, 164, 165, 181, 187])),
			_Utils_Tuple2(
			10,
			_List_fromArray(
				[20, 27, 40, 60, 62, 66, 155, 158, 162])),
			_Utils_Tuple2(
			11,
			_List_fromArray(
				[136, 162, 165, 172, 180, 190, 193])),
			_Utils_Tuple2(
			12,
			_List_fromArray(
				[6, 16, 27, 30, 31, 41, 54, 62, 63, 64, 67, 77, 78, 85, 86, 97, 116, 118, 121, 130, 132, 137, 140, 144, 148, 151, 155, 163, 164, 172, 174, 175, 176, 177, 178, 184, 188, 194, 196])),
			_Utils_Tuple2(
			13,
			_List_fromArray(
				[9, 14, 16, 26, 30, 31, 36, 41, 42, 54, 57, 58, 62, 66, 67, 76, 77, 97, 116, 133, 135, 139, 144, 148, 151, 155, 161, 164, 171, 172, 173, 174, 180, 188, 194, 196])),
			_Utils_Tuple2(
			14,
			_List_fromArray(
				[164, 175, 187])),
			...
			15,
			_List_fromArray(
				[15, 120, 135, 138, 140, 158, 164, 175])),
			_Utils_Tuple2(
			16,
			_List_fromArray(
				[166])),
			...
			18,
			_List_fromArray(
				[27, 35, 47, 50, 54, 62, 66, 67, 78, 84, 97, 106, 115, 121, 122, 128, 132, 133, 135, 136, 137, 138, 139, 140, 142, 144, 148, 154, 156, 158, 162, 164, 165, 170, 171, 172, 174, 175, 176, 179, 180, 181, 183, 186, 191, 192, 193])),
			_Utils_Tuple2(
			19,
			_List_fromArray(
				[88])),
			...
			21,
			_List_fromArray(
				[5, 16, 30, 35, 40, 47, 54, 58, 62, 64, 66, 77, 78, 97, 139, 144, 149, 158, 174, 175, 176, 177, 178, 179, 188, 196])),
			_Utils_Tuple2(
			22,
			_List_fromArray(
				[4, 5, 7, 10, 12, 13, 14, 15, 16, 19, 20, 23, 25, 26, 27, 28, 30, 31, 34, 35, 40, 50, 51, 52, 54, 58, 60, 61, 62, 63, 64, 66, 67, 70, 77, 79, 82, 83, 84, 86, 87, 92, 97, 98, 101, 104, 106, 107, 115, 116, 121, 122, 123, 124, 125, 128, 130, 131, 132, 133, 135, 137, 138, 139, 142, 143, 144, 146, 147, 148, 151, 153, 154, 155, 158, 159, 160, 161, 162, 164, 166, 168, 169, 171, 172, 173, 174, 175, 176, 177, 178, 179, 180, 181, 183, 184, 186, 187, 188, 191, 192, 196, 197])),
			_Utils_Tuple2(
			23,
			_List_fromArray(
				[10, 47, 50, 64, 66, 85, 106, 107, 121, 122, 124, 131, 135, 138, 140, 141, 148, 152, 164, 172, 175, 177, 184])),
			_Utils_Tuple2(
			24,
			_List_fromArray(
				[27, 31, 50, 53, 54, 62, 66, 67, 84, 85, 97, 121, 122, 124, 128, 130, 131, 132, 135, 136, 137, 138, 139, 140, 141, 142, 148, 155, 156, 162, 164, 166, 170, 172, 174, 175, 180, 181, 184, 187, 193])),
			_Utils_Tuple2(
			25,
			_List_fromArray(
				[30, 34, 127, 130, 135, 188, 191, 197])),
			_Utils_Tuple2(
			26,
			_List_fromArray(
				[5, 16, 24, 28, 31, 34, 35, 40, 53, 54, 64, 70, 85, 97, 107, 135, 138, 141, 161, 174, 176, 178, 180, 196])),
			_Utils_Tuple2(
			27,
			_List_fromArray(
				[4, 5, 9, 16, 20, 23, 25, 30, 31, 34, 36, 41, 54, 57, 58, 62, 64, 67, 69, 70, 76, 77, 80, 86, 88, 92, 95, 97, 98, 104, 123, 127, 130, 132, 135, 139, 144, 151, 155, 156, 158, 160, 166, 167, 168, 169, 174, 176, 177, 178, 179, 186, 188, 189, 193, 194, 196])),
			_Utils_Tuple2(
			28,
			_List_fromArray(
				[23, 27, 28, 30, 35, 47, 50, 54, 58, 62, 64, 66, 77, 85, 106, 115, 121, 122, 123, 135, 137, 138, 140, 141, 143, 148, 149, 155, 156, 161, 163, 164, 165, 172, 174, 175, 176, 177, 178, 179, 180, 184, 188, 197])),
			_Utils_Tuple2(
			29,
			_List_fromArray(
				[53, 92, 106, 115, 122, 132, 135, 138, 139, 142, 148, 162, 164, 165, 166, 172])),
			_Utils_Tuple2(
			30,
			_List_fromArray(
				[115, 121, 122, 165, 169, 172])),
			_Utils_Tuple2(
			31,
			_List_fromArray(
				[2, 108, 150, 178, 179])),
			...
			32,
			_List_fromArray(
				[5, 16, 20, 23, 31, 36, 58, 67, 79, 95, 98, 104, 153, 158, 167, 171])),
			_Utils_Tuple2(
			33,
			_List_fromArray(
				[4, 5, 10, 13, 15, 16, 20, 23, 24, 25, 26, 27, 28, 30, 31, 34, 35, 40, 42, 47, 50, 53, 54, 58, 62, 63, 66, 67, 70, 77, 78, 84, 85, 92, 97, 104, 106, 107, 115, 116, 121, 122, 123, 124, 128, 129, 130, 131, 132, 133, 135, 136, 137, 138, 139, 140, 141, 142, 143, 144, 148, 153, 154, 155, 156, 158, 160, 161, 162, 163, 164, 165, 166, 168, 169, 170, 171, 172, 173, 174, 175, 176, 177, 178, 179, 180, 181, 183, 184, 186, 187, 188, 191, 192, 193, 196, 197])),
			_Utils_Tuple2(
			34,
			_List_fromArray(
				[23, 25, 27, 30, 40, 64, 67, 73, 74, 78, 97, 115, 124, 127, 130, 137, 158, 160, 173, 176, 178, 179, 180, 188, 196, 203])),
			_Utils_Tuple2(
			35,
			_List_fromArray(
				[4, 13, 14, 31, 34, 36, 49, 62, 67, 88, 97, 115, 122, 126, 128, 160, 175, 177, 178, 190, 192])),
			_Utils_Tuple2(
			36,
			_List_fromArray(
				[33, 54, 65, 70, 88, 109, 145])),
			_Utils_Tuple2(
			37,
			_List_fromArray(
				[27, 53, 84, 85, 122, 135, 137, 138, 140, 156, 161, 166, 172, 176])),
			_Utils_Tuple2(
			38,
			_List_fromArray(
				[5, 9, 14, 16, 20, 23, 24, 26, 30, 31, 35, 36, 37, 38, 40, 41, 42, 46, 47, 51, 54, 57, 58, 62, 63, 64, 66, 67, 70, 76, 77, 80, 86, 87, 97, 98, 104, 107, 110, 113, 115, 116, 123, 130, 132, 133, 135, 139, 143, 144, 151, 153, 154, 155, 158, 159, 160, 161, 163, 164, 167, 168, 169, 171, 173, 174, 176, 177, 178, 179, 180, 186, 188, 189, 191, 192, 194, 196, 203])),
			_Utils_Tuple2(
			39,
			_List_fromArray(
				[120, 142, 187])),
			...
			41,
			_List_fromArray(
				[3, 4, 5, 9, 14, 16, 18, 23, 30, 31, 34, 36, 42, 43, 56, 61, 62, 64, 67, 70, 72, 77, 83, 84, 88, 89, 91, 92, 94, 101, 109, 111, 122, 126, 127, 128, 129, 130, 131, 132, 135, 139, 141, 142, 147, 151, 156, 158, 165, 166, 171, 173, 176, 177, 178, 179, 187, 189, 190, 191, 192, 193, 194, 196, 197, 198])),
			_Utils_Tuple2(
			42,
			_List_fromArray(
				[27, 50, 92, 122, 131, 135, 136, 137, 138, 152, 156, 160, 162, 164, 166, 170, 176, 177, 180])),
			_Utils_Tuple2(
			43,
			_List_fromArray(
				[13, 131, 165, 176, 196])),
			...
			44,
			_List_fromArray(
				[10, 15, 16, 23, 27, 28, 30, 31, 42, 47, 53, 54, 58, 66, 67, 70, 77, 78, 84, 85, 92, 97, 106, 112, 115, 120, 121, 122, 128, 129, 131, 132, 133, 135, 136, 137, 138, 139, 140, 141, 142, 148, 152, 156, 161, 162, 164, 165, 166, 168, 169, 170, 172, 175, 176, 177, 180, 181, 184, 187, 188, 193, 196])),
			_Utils_Tuple2(
			45,
			_List_fromArray(
				[4, 5, 13, 14, 16, 17, 21, 23, 25, 26, 31, 34, 42, 58, 60, 61, 62, 63, 64, 67, 70, 74, 75, 77, 78, 88, 97, 101, 104, 105, 107, 115, 122, 127, 128, 130, 131, 135, 140, 147, 148, 154, 155, 159, 160, 161, 163, 164, 167, 168, 169, 173, 176, 177, 179, 180, 184, 188, 189, 190, 191, 192, 193, 195, 196, 201, 203])),
			_Utils_Tuple2(
			46,
			_List_fromArray(
				[16, 23, 30, 40, 47, 50, 62, 64, 66, 67, 84, 85, 97, 107, 121, 122, 130, 135, 137, 138, 139, 140, 141, 148, 156, 160, 164, 165, 166, 172, 174, 175, 176, 177, 178, 180, 184, 187, 193, 196])),
			_Utils_Tuple2(
			47,
			_List_fromArray(
				[20, 35, 40, 50, 66, 70, 115, 142, 162, 188])),
			_Utils_Tuple2(
			48,
			_List_fromArray(
				[10, 27, 31, 106, 122, 130, 133, 138, 139, 140, 144, 155, 158, 166, 177, 178, 203])),
			_Utils_Tuple2(
			49,
			_List_fromArray(
				[16, 20, 23, 30, 31, 35, 36, 42, 53, 62, 66, 67, 78, 84, 85, 92, 97, 115, 122, 125, 131, 132, 133, 135, 136, 137, 139, 140, 142, 152, 156, 161, 165, 170, 171, 172, 174, 175, 176, 178, 181, 184, 186, 187, 188, 191, 193, 196])),
			_Utils_Tuple2(
			50,
			_List_fromArray(
				[163])),
			...
			51,
			_List_fromArray(
				[13, 67, 115, 128, 138, 175, 176, 180])),
			_Utils_Tuple2(
			52,
			_List_fromArray(
				[4, 5, 12, 13, 16, 20, 23, 25, 27, 28, 30, 31, 39, 40, 47, 64, 67, 70, 84, 85, 87, 92, 97, 106, 112, 121, 122, 128, 129, 130, 131, 132, 133, 135, 136, 137, 138, 139, 141, 142, 144, 146, 148, 152, 155, 156, 162, 164, 166, 168, 169, 170, 171, 175, 177, 178, 180, 183, 184, 187, 188, 196])),
			_Utils_Tuple2(
			53,
			_List_fromArray(
				[97])),
			...
			56,
			_List_fromArray(
				[5, 20, 25, 27, 30, 31, 62, 67, 77, 104, 107, 132, 158, 160, 171, 179, 191])),
			_Utils_Tuple2(
			57,
			_List_fromArray(
				[27, 35, 53, 85, 121, 132, 135, 140, 142, 148, 156, 164, 166, 172, 175, 180, 181, 184, 188])),
			_Utils_Tuple2(
			58,
			_List_fromArray(
				[84, 106, 140, 166, 193])),
			...
			59,
			_List_fromArray(
				[53, 121, 135, 138, 140, 148, 156, 164, 172])),
			_Utils_Tuple2(
			60,
			_List_fromArray(
				[7, 25, 26, 77, 115, 147, 186, 189, 191])),
			_Utils_Tuple2(
			61,
			_List_fromArray(
				[4, 13, 14, 15, 23, 25, 27, 30, 31, 42, 53, 58, 61, 62, 66, 67, 77, 78, 84, 85, 88, 92, 97, 106, 107, 112, 115, 120, 122, 126, 128, 129, 130, 131, 132, 133, 135, 136, 137, 139, 140, 142, 144, 148, 152, 156, 158, 159, 160, 161, 162, 164, 165, 166, 169, 170, 171, 172, 174, 175, 176, 177, 180, 181, 183, 184, 187, 188, 190, 191, 192, 193, 195, 196, 203])),
			_Utils_Tuple2(
			62,
			_List_fromArray(
				[29, 42, 54, 78, 128, 135, 148, 156, 164, 165, 166, 181, 193])),
			_Utils_Tuple2(
			63,
			_List_fromArray(
				[4, 27, 30, 53, 66, 78, 84, 85, 92, 106, 112, 122, 128, 131, 133, 135, 136, 137, 138, 139, 140, 148, 162, 164, 165, 166, 170, 172, 175, 177, 180, 181, 187, 192, 196])),
			_Utils_Tuple2(
			64,
			_List_fromArray(
				[16, 30, 31, 39, 62, 67, 77, 177, 184, 188])),
			_Utils_Tuple2(
			65,
			_List_fromArray(
				[73, 106, 115])),
			...
			66,
			_List_fromArray(
				[27, 53, 77, 84, 85, 87, 121, 135, 137, 138, 140, 142, 148, 156, 164, 166, 172, 175, 180, 181])),
			_Utils_Tuple2(
			67,
			_List_fromArray(
				[54, 175, 188, 194])),
			...
			68,
			_List_fromArray(
				[31, 35, 39, 54, 58, 63, 67, 70, 85, 97, 124, 138, 166, 168, 177, 188, 196, 197])),
			_Utils_Tuple2(
			69,
			_List_fromArray(
				[156])),
			...
			70,
			_List_fromArray(
				[11, 20, 27, 28, 30, 31, 36, 58, 60, 62, 67, 70, 77, 88, 97, 98, 104, 130, 132, 135, 140, 144, 146, 151, 158, 159, 160, 167, 171, 174, 177, 178, 183, 184, 186, 194, 196])),
			_Utils_Tuple2(
			71,
			_List_fromArray(
				[140])),
			...
			72,
			_List_fromArray(
				[4, 5, 10, 12, 13, 15, 16, 20, 23, 25, 27, 28, 30, 31, 34, 35, 39, 40, 52, 53, 54, 58, 62, 63, 64, 67, 70, 77, 78, 84, 85, 88, 92, 97, 98, 101, 104, 106, 107, 112, 115, 116, 120, 122, 124, 125, 128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 140, 141, 142, 143, 144, 148, 152, 154, 155, 156, 158, 159, 160, 161, 162, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174, 175, 176, 177, 178, 179, 180, 183, 184, 186, 187, 188, 190, 191, 193, 196, 197])),
			_Utils_Tuple2(
			73,
			_List_fromArray(
				[35, 40, 169])),
			...
			74,
			_List_fromArray(
				[53, 67, 77, 84, 132, 133, 135, 138, 140, 148, 162, 164, 193, 203])),
			_Utils_Tuple2(
			75,
			_List_fromArray(
				[4, 5, 13, 14, 27, 34, 58, 77, 88, 106, 115, 128, 129, 130, 135, 137, 139, 140, 141, 142, 144, 148, 155, 159, 162, 164, 166, 169, 172, 177, 180, 183, 190, 192, 203])),
			_Utils_Tuple2(
			76,
			_List_fromArray(
				[4, 5, 12, 15, 16, 20, 24, 28, 30, 34, 35, 39, 40, 42, 47, 53, 58, 63, 66, 67, 70, 77, 78, 79, 84, 85, 87, 88, 92, 96, 97, 98, 112, 116, 120, 121, 122, 128, 129, 130, 131, 132, 135, 136, 138, 139, 140, 141, 142, 144, 146, 148, 149, 152, 156, 158, 159, 160, 162, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 175, 176, 177, 180, 184, 187, 188, 189, 190, 191, 193, 194, 196, 203])),
			_Utils_Tuple2(
			77,
			_List_fromArray(
				[172, 176])),
			...
			78,
			_List_fromArray(
				[10, 16, 20, 25, 26, 30, 31, 35, 36, 47, 54, 58, 60, 62, 63, 64, 67, 70, 77, 78, 84, 86, 87, 92, 97, 98, 121, 128, 129, 130, 131, 132, 133, 135, 136, 137, 138, 139, 144, 146, 147, 151, 155, 158, 159, 160, 165, 167, 168, 169, 170, 171, 172, 173, 176, 177, 179, 180, 183, 184, 187, 188, 190, 194, 196])),
			_Utils_Tuple2(
			79,
			_List_fromArray(
				[138])),
			...
			81,
			_List_fromArray(
				[4, 10, 23, 27, 28, 30, 47, 50, 53, 54, 62, 66, 67, 77, 84, 85, 92, 97, 106, 112, 115, 121, 122, 128, 132, 133, 135, 136, 137, 138, 139, 140, 141, 142, 148, 156, 159, 162, 164, 165, 166, 168, 169, 170, 172, 175, 176, 177, 180, 181, 184, 187, 193])),
			_Utils_Tuple2(
			82,
			_List_fromArray(
				[10, 16, 23, 27, 28, 30, 31, 40, 44, 47, 50, 54, 62, 64, 66, 67, 78, 84, 85, 97, 106, 107, 116, 121, 122, 130, 131, 133, 135, 136, 137, 138, 140, 141, 142, 148, 152, 155, 156, 158, 160, 161, 164, 165, 166, 169, 171, 172, 174, 175, 176, 177, 178, 180, 184, 186, 187, 188, 189, 196, 197])),
			_Utils_Tuple2(
			83,
			_List_fromArray(
				[4, 5, 13, 14, 15, 16, 20, 25, 27, 30, 31, 34, 35, 36, 40, 53, 54, 58, 60, 62, 63, 67, 70, 77, 78, 83, 84, 86, 87, 92, 95, 97, 98, 104, 106, 128, 133, 135, 136, 137, 143, 144, 146, 154, 155, 160, 163, 167, 168, 171, 172, 177, 178, 179, 180, 183, 186, 187, 188, 190, 191, 192, 194, 196, 203])),
			_Utils_Tuple2(
			84,
			_List_fromArray(
				[16, 27, 28, 40, 64, 97, 103, 127, 135, 137, 160, 165, 169, 177, 178, 185, 188, 196])),
			_Utils_Tuple2(
			85,
			_List_fromArray(
				[22, 27, 48, 50, 53, 84, 85, 103, 106, 122, 125, 128, 133, 135, 136, 137, 138, 140, 142, 148, 152, 156, 157, 161, 164, 165, 166, 170, 172, 175, 176, 180, 181])),
			_Utils_Tuple2(
			86,
			_List_fromArray(
				[5, 16, 24, 25, 31, 34, 35, 40, 53, 62, 64, 70, 97, 106, 107, 115, 124, 138, 143, 154, 158, 159, 161, 168, 169, 173, 174, 175, 176, 178, 179, 180, 183, 191, 196, 197])),
			_Utils_Tuple2(
			87,
			_List_fromArray(
				[35, 128, 166, 184, 193])),
			...
			88,
			_List_fromArray(
				[5, 16, 20, 25, 28, 35, 53, 54, 64, 70, 85, 97, 116, 130, 135, 138, 141, 143, 154, 158, 168, 169, 173, 174, 175, 176, 178, 197])),
			_Utils_Tuple2(
			89,
			_List_fromArray(
				[5, 15, 23, 27, 50, 53, 78, 84, 92, 106, 121, 122, 128, 130, 131, 135, 136, 137, 138, 140, 141, 142, 148, 156, 164, 166, 175, 177, 187, 191, 193])),
			_Utils_Tuple2(
			90,
			_List_fromArray(
				[1, 8, 11, 14, 16, 25, 27, 32, 33, 34, 36, 38, 42, 43, 49, 53, 55, 59, 70, 78, 81, 85, 90, 91, 92, 93, 94, 95, 98, 99, 111, 117, 122, 126, 130, 131, 132, 135, 137, 140, 141, 143, 144, 145, 158, 162, 166, 169, 172, 175, 178, 179, 180, 187, 191, 193, 195, 197])),
			_Utils_Tuple2(
			91,
			_List_fromArray(
				[184])),
			...
			92,
			_List_fromArray(
				[27, 122, 130, 137, 143, 160, 177, 179])),
			_Utils_Tuple2(
			93,
			_List_fromArray(
				[26, 30, 34, 53, 58, 63, 67, 97, 101, 135, 139, 141, 144, 169, 172, 175, 188])),
			_Utils_Tuple2(
			94,
			_List_fromArray(
				[142])),
			...
			95,
			_List_fromArray(
				[5, 10, 27, 28, 40, 124, 138, 176])),
			_Utils_Tuple2(
			96,
			_List_fromArray(
				[10, 20, 26, 27, 40, 63, 64, 67, 77, 97, 115, 121, 124, 137, 138, 162, 180, 196])),
			_Utils_Tuple2(
			97,
			_List_fromArray(
				[42, 162, 184])),
			...
			98,
			_List_fromArray(
				[14, 16, 104, 115, 130, 144, 151, 164])),
			_Utils_Tuple2(
			99,
			_List_fromArray(
				[15, 47, 53, 84, 92, 97, 115, 122, 128, 129, 140, 142, 148, 162, 164, 165, 168, 175, 177])),
			_Utils_Tuple2(
			100,
			_List_fromArray(
				[5, 34, 188])),
			...
			102,
			_List_fromArray(
				[5, 16, 20, 26, 27, 28, 30, 31, 50, 53, 58, 62, 70, 78, 97, 101, 103, 114, 115, 122, 124, 128, 129, 130, 133, 135, 138, 139, 140, 141, 142, 148, 155, 156, 159, 161, 162, 163, 164, 165, 166, 168, 169, 170, 171, 172, 175, 176, 177, 178, 182, 187, 188, 196, 197])),
			_Utils_Tuple2(
			103,
			_List_fromArray(
				[20, 31, 58, 95, 98, 115, 130])),
			_Utils_Tuple2(
			104,
			_List_fromArray(
				[44, 70])),
			...
			107,
			_List_fromArray(
				[10, 27, 31, 53, 54, 62, 68, 85, 116, 121, 122, 124, 128, 130, 138, 139, 148, 155, 158, 169, 170, 172, 175, 177, 184, 186, 191])),
			_Utils_Tuple2(
			108,
			_List_fromArray(
				[15, 27, 53, 67, 77, 78, 92, 112, 115, 122, 128, 129, 131, 132, 133, 135, 137, 138, 139, 140, 142, 148, 155, 162, 164, 165, 166, 170, 172, 175, 180, 181, 183, 187, 193])),
			_Utils_Tuple2(
			109,
			_List_fromArray(
				[4, 13, 14, 27, 30, 34, 62, 66, 77, 85, 92, 97, 106, 115, 122, 128, 131, 135, 137, 138, 139, 140, 152, 155, 156, 159, 160, 162, 164, 165, 166, 172, 174, 175, 176, 177, 180, 181, 188, 193])),
			_Utils_Tuple2(
			110,
			_List_fromArray(
				[115, 133])),
			...
			111,
			_List_fromArray(
				[27, 50, 53, 66, 77, 84, 85, 106, 115, 121, 122, 131, 132, 133, 135, 136, 137, 138, 140, 141, 142, 148, 156, 162, 164, 165, 166, 175, 177, 180, 181, 184, 187, 193])),
			_Utils_Tuple2(
			112,
			_List_fromArray(
				[23, 27, 30, 40, 53, 67, 97, 103, 122, 124, 136, 155, 163, 170, 174, 175, 176, 178, 188, 196])),
			_Utils_Tuple2(
			113,
			_List_fromArray(
				[27, 78, 137, 138, 140, 148, 172, 196])),
			_Utils_Tuple2(
			114,
			_List_fromArray(
				[4, 10, 15, 23, 27, 28, 30, 31, 42, 53, 54, 58, 63, 66, 67, 70, 77, 78, 84, 85, 92, 106, 112, 115, 120, 121, 122, 124, 125, 128, 129, 131, 132, 133, 135, 136, 137, 138, 139, 140, 141, 142, 144, 148, 152, 156, 161, 162, 164, 165, 166, 168, 170, 171, 172, 175, 176, 177, 180, 181, 183, 184, 187, 188, 193, 196, 197])),
			_Utils_Tuple2(
			115,
			_List_fromArray(
				[138])),
			...
			116,
			_List_fromArray(
				[66, 135, 137, 140, 175, 184])),
			_Utils_Tuple2(
			117,
			_List_fromArray(
				[4, 5, 10, 13, 14, 15, 16, 17, 23, 24, 25, 26, 27, 28, 30, 31, 34, 35, 42, 47, 53, 54, 58, 60, 61, 62, 63, 64, 66, 67, 70, 74, 77, 78, 83, 84, 85, 88, 92, 97, 101, 104, 106, 107, 115, 121, 122, 123, 124, 125, 128, 129, 130, 131, 132, 133, 135, 136, 137, 138, 139, 140, 141, 142, 143, 144, 148, 152, 153, 154, 155, 156, 158, 159, 160, 161, 162, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174, 175, 176, 177, 178, 179, 180, 181, 183, 184, 185, 186, 187, 188, 190, 191, 192, 193, 196, 197, 200, 203])),
			_Utils_Tuple2(
			118,
			_List_fromArray(
				[144, 188, 194])),
			...
			122,
			_List_fromArray(
				[31, 34, 53, 63, 70, 115, 121, 122, 135, 154, 155, 156, 158, 178, 188, 191, 193])),
			_Utils_Tuple2(
			123,
			_List_fromArray(
				[31, 61, 87, 100, 115, 142, 148, 191, 203])),
			_Utils_Tuple2(
			124,
			_List_fromArray(
				[5, 16, 30, 34, 42, 54, 58, 63, 67, 70, 74, 85, 97, 98, 107, 115, 116, 124, 130, 131, 132, 135, 154, 158, 160, 163, 169, 174, 177, 178, 184, 187, 188, 190, 197, 201])),
			_Utils_Tuple2(
			125,
			_List_fromArray(
				[4, 5, 10, 13, 14, 16, 20, 23, 24, 25, 27, 28, 30, 31, 34, 35, 40, 42, 53, 54, 58, 60, 61, 62, 63, 64, 66, 67, 70, 77, 78, 85, 88, 92, 97, 98, 104, 106, 107, 115, 116, 121, 122, 124, 129, 130, 131, 132, 133, 135, 136, 137, 138, 140, 141, 142, 143, 144, 152, 153, 154, 155, 156, 158, 159, 160, 162, 163, 164, 165, 166, 167, 168, 170, 171, 172, 173, 174, 175, 176, 177, 178, 179, 180, 183, 185, 186, 187, 188, 190, 192, 193, 196, 197, 203])),
			_Utils_Tuple2(
			126,
			_List_fromArray(
				[27, 35, 40, 67, 85, 97, 130, 137, 188])),
			_Utils_Tuple2(
			127,
			_List_fromArray(
				[5, 13, 20, 23, 24, 25, 26, 30, 34, 35, 45, 54, 58, 60, 61, 62, 63, 66, 67, 70, 77, 78, 88, 97, 98, 101, 104, 105, 106, 107, 121, 122, 123, 126, 127, 129, 130, 131, 132, 135, 146, 147, 153, 154, 155, 158, 159, 160, 162, 163, 165, 167, 169, 171, 173, 174, 177, 178, 179, 182, 183, 186, 188, 189, 190, 191, 192, 197, 203])),
			_Utils_Tuple2(
			128,
			_List_fromArray(
				[10, 47, 50, 112, 115, 138, 142, 148, 164, 166])),
			_Utils_Tuple2(
			129,
			_List_fromArray(
				[13, 16, 17, 25, 34, 54, 58, 60, 61, 62, 67, 74, 77, 78, 88, 97, 100, 101, 105, 126, 127, 131, 139, 152, 154, 155, 159, 160, 161, 162, 164, 166, 167, 168, 169, 173, 174, 176, 179, 182, 183, 184, 186, 189, 190, 191, 192, 196, 197, 203])),
			_Utils_Tuple2(
			130,
			_List_fromArray(
				[27, 53, 71, 102, 122, 135, 162, 164, 165, 175, 203])),
			_Utils_Tuple2(
			131,
			_List_fromArray(
				[11, 20, 24, 26, 30, 35, 36, 39, 40, 58, 62, 63, 64, 67, 70, 78, 83, 97, 98, 116, 130, 138, 141, 143, 144, 146, 147, 154, 155, 158, 159, 160, 167, 168, 169, 171, 173, 176, 177, 186, 188, 189, 197])),
			_Utils_Tuple2(
			132,
			_List_fromArray(
				[119, 137, 141, 156, 164, 166, 175])),
			_Utils_Tuple2(
			133,
			_List_fromArray(
				[4, 5, 13, 62, 106, 131, 139, 152, 156, 160, 164, 165, 166, 172, 175, 178, 187, 199]))
		]));
var $author$project$Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ChooseAUni':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							chooserMode: function () {
								var _v1 = model.chooserMode;
								if (_v1.$ === 'Uni') {
					...
					$elm$core$Platform$Cmd$none);
			case 'ChooseAQuestion':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							chooserMode: function () {
								var _v2 = model.chooserMode;
								if (_v2.$ === 'Question') {
									return $author$project$DataTypes$FoldedUp;
								} else {
				...
				if (msg.a.$ === 'UniVsA') {
					...
					return $author$project$Update$freshModel(
						_Utils_update(
							model,
							{
								axesConfig: $author$project$DataTypes$QVsA,
								chooserMode: $author$project$DataTypes$Uni(''),
								questions: $elm$core$Dict$keys($author$project$DataTypes$questionCodes),
								unis: _List_Nil
							}));
				}
			case 'SelectAllUnis':
						...
						if (_v9.$ === 'Overall') {
							...
							if (_v9.a.$ === 'Just') {
								...
								return _Utils_update(
									model,
									{
										unis: $elm$core$Dict$keys($author$project$Data$uniCodes)
									});
							}
						}
					}());
			...
			case 'ClearAllQuestions':
				return $author$project$Update$freshModel(
					_Utils_update(
						model,
						{questions: _List_Nil}));
			case 'UniChooserSearchText':
				var txt = msg.a;
				var _v12 = A2($author$project$Update$search4words, model.uniSearchIndex, txt);
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							chooserMode: $author$project$DataTypes$Uni(txt),
							uniSearchIndex: newSearchIndex,
							uniSearchResults: searchResults
						}),
					$elm$core$Platform$Cmd$none);
			case 'SubjectChooserSearchText':
				var txt = msg.a;
				var _v13 = A2($author$project$Update$search4words, model.subjectSearchIndex, txt);
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							chooserMode: $author$project$DataTypes$Subject(txt),
				...
				if (_v14.a.$ === 'Nothing') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								fatalErr: $elm$core$Maybe$Just('Could not find subject in \'unisOffering\'' + ' dictionary.')
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					if (_v14.b.$ === 'UniVsA') {
						...
						return $author$project$Update$freshModel(
							_Utils_update(
								model,
								{
									chartMode: $author$project$DataTypes$BySubject(
				...
				if (_v20.$ === 'Nothing') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								fatalErr: $elm$core$Maybe$Just('Could not find university in \'subjectsOffered\'' + ' dictionary.')
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var subjects = _v20.a;
			...
			case 'ToggleQuestion':
				...
				return $author$project$Update$freshModel(
					_Utils_update(
						model,
						{
							questions: A2($author$project$Update$calculateDataChoice, model.questions, question)
						}));
			case 'ChangeQuestion':
				var q = msg.a;
				return $author$project$Update$freshModel(
			...
			case 'ToggleUni':
				...
				return $author$project$Update$freshModel(
					_Utils_update(
						model,
						{
							unis: A2($author$project$Update$calculateDataChoice, model.unis, uni)
						}));
			case 'OverallMode':
				return $author$project$Update$freshModel(
					function () {
						var _v25 = model.axesConfig;
						if (_v25.$ === 'UniVsA') {
							return _Utils_update(
								model,
								{
			...
			case 'SubjectMode':
				return $author$project$Update$freshModel(
					_Utils_update(
						model,
						{
							chartMode: $author$project$DataTypes$BySubject($elm$core$Maybe$Nothing),
							chooserMode: $author$project$DataTypes$Subject(''),
							uniSearchIndex: $author$project$Update$makeSearchIndex($author$project$Data$uniCodes),
							unis: _List_Nil
						}));
			default:
				var dat = msg.a;
				if (dat.$ === 'Err') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								getRequestErr: $elm$core$Maybe$Just(
									$author$project$Update$errToStr(err)),
								pageLoading: false
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var error = dat.a.error;
					var result = dat.a.result;
					if (error === '') {
						...
						if (_v27.$ === 'Just') {
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{data: goodresult, getRequestErr: $elm$core$Maybe$Nothing, pageLoading: false}),
								$elm$core$Platform$Cmd$none);
						} else {
							return _Utils_Tuple2(
								_Utils_update(
									...
									{
										data: _List_Nil,
										getRequestErr: $elm$core$Maybe$Just('Couldn\'t convert data to tuples.'),
										pageLoading: false
									}),
								$elm$core$Platform$Cmd$none);
						}
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									getRequestErr: $elm$core$Maybe$Just(error),
									pageLoading: false
								}),
							$elm$core$Platform$Cmd$none);
					}
...
var $author$project$AxisLabels$Medium = {$: 'Medium'};
var $author$project$AxisLabels$Thick = {$: 'Thick'};
var $author$project$AxisLabels$Thin = {$: 'Thin'};
...
var $author$project$AxisLabels$xAxisLabels = F4(
	function (model, xoffset, yoffset, numYLabels) {
		...
		return _Utils_ap(
			A2(
				grid,
				$author$project$AxisLabels$Thick,
				_List_fromArray(
					[0, 20, 40, 60, 80, 100])),
			_Utils_ap(
				A2(
					grid,
					$author$project$AxisLabels$Medium,
					_List_fromArray(
						[10, 30, 50, 70, 90])),
				_Utils_ap(
					A2(
						grid,
						$author$project$AxisLabels$Thin,
						_List_fromArray(
...
var $author$project$AxisLabels$axisValues = F2(
	function (model, axisType) {
		if (axisType.$ === 'UniAxis') {
			var _v1 = _Utils_Tuple2(model.unis, model.chartMode);
			if (!_v1.a.b) {
				if (_v1.b.$ === 'BySubject') {
					return $elm$core$Dict$keys($author$project$Data$uniCodes);
				} else {
...
var $author$project$DataTypes$QuestionAxis = {$: 'QuestionAxis'};
var $author$project$DataTypes$UniAxis = {$: 'UniAxis'};
var $author$project$DataTypes$yAxisType = function (axesConfig) {
	if (axesConfig.$ === 'UniVsA') {
		return $author$project$DataTypes$UniAxis;
	} else {
		return $author$project$DataTypes$QuestionAxis;
	}
};
var $author$project$AxisLabels$yAxisLabels = F3(
	function (model, xoffset, yoffset) {
		var axisType = $author$project$DataTypes$yAxisType(model.axesConfig);
		...
		return $elm_community$maybe_extra$Maybe$Extra$combine(
			A3(
				$elm$core$List$map2,
				A3($author$project$AxisLabels$oneYLabel, model.chartMode, axisType, yoffset),
				yPositions,
				yVals));
	});
var $author$project$Chart$chart = function (model) {
	var yAxisTypel = $author$project$DataTypes$yAxisType(model.axesConfig);
...
var $author$project$View$QuestionErr = {$: 'QuestionErr'};
var $author$project$View$SubjectErr = {$: 'SubjectErr'};
var $author$project$View$UniErr = {$: 'UniErr'};
...
var $author$project$View$errorMsg = function (_v0) {
	var pageLoading = _v0.pageLoading;
	var axesConfig = _v0.axesConfig;
	var chartMode = _v0.chartMode;
	var data = _v0.data;
	var getRequestErr = _v0.getRequestErr;
	var unis = _v0.unis;
	var questions = _v0.questions;
	...
	if (_v1.a.a) {
		...
		if (_v1.a.b.$ === 'Just') {
			...
			if (!_v1.a.c.b) {
				...
				var _v7 = _v1.b;
				return $elm$core$Maybe$Just(
					$author$project$View$noSelectErrorMsg($author$project$View$UniErr));
			} else {
				if ((_v1.b.a.$ === 'BySubject') && (_v1.b.a.a.$ === 'Nothing')) {
					var _v8 = _v1.a;
					var _v9 = _v1.b;
					var _v10 = _v9.a.a;
					return $elm$core$Maybe$Just(
						$author$project$View$noSelectErrorMsg($author$project$View$SubjectErr));
				} else {
					if (!_v1.b.b.b) {
						var _v11 = _v1.a;
						var _v12 = _v1.b;
						return $elm$core$Maybe$Just(
							$author$project$View$noSelectErrorMsg($author$project$View$QuestionErr));
					} else {
						if (!_v1.b.c.b) {
							var _v13 = _v1.a;
							var _v14 = _v1.b;
...
var $author$project$DataTypes$ChooseAQuestion = {$: 'ChooseAQuestion'};
var $author$project$DataTypes$ChooseASubject = {$: 'ChooseASubject'};
var $author$project$DataTypes$ChooseAUni = {$: 'ChooseAUni'};
var $author$project$DataTypes$OverallMode = {$: 'OverallMode'};
var $author$project$DataTypes$SubjectMode = {$: 'SubjectMode'};
var $author$project$DataChooser$Tick = {$: 'Tick'};
var $author$project$DataChooser$axisMessagesAndLabels = _List_fromArray(
	[
		_Utils_Tuple2($author$project$DataTypes$UniVsA, 'Compare universities'),
		_Utils_Tuple2($author$project$DataTypes$QVsA, 'Look at one university')
	]);
...
var $author$project$DataTypes$AxesConfigChoice = function (a) {
	return {$: 'AxesConfigChoice', a: a};
};
var $author$project$DataChooser$Radio = {$: 'Radio'};
var $author$project$DataChooser$radioButton = F2(
	function (alreadyChosen, _v0) {
		...
		return A5(
			...
			$author$project$DataChooser$Radio,
				...
				_List_fromArray(
					[
						...
						[
							A5(
							$author$project$DataChooser$checkBox,
							$author$project$DataChooser$Tick,
							function () {
								if (chartMode.$ === 'Overall') {
...
var $author$project$DataTypes$ClearAllQuestions = {$: 'ClearAllQuestions'};
var $author$project$DataTypes$SelectAllQuestions = {$: 'SelectAllQuestions'};
var $author$project$DataTypes$ToggleQuestion = function (a) {
	return {$: 'ToggleQuestion', a: a};
};
...
var $author$project$DataTypes$ClearAllUnis = {$: 'ClearAllUnis'};
var $author$project$DataTypes$SelectAllUnis = {$: 'SelectAllUnis'};
...
var $author$project$DataChooser$radioOrTick = function (axConf) {
	if (axConf.$ === 'UniVsA') {
		return $author$project$DataChooser$Tick;
	} else {
		return $author$project$DataChooser$Radio;
	}
};
...
var $author$project$DataChooser$dataChooserButtons_ = F2(
	function (_v0, model) {
		...
		var subject = _v0.subject;
		var uniSearchText = _v0.uniSearchText;
		var subjectSearchText = _v0.subjectSearchText;
		return $elm$core$List$concat(
			_List_fromArray(
				[
					_List_fromArray(
					[
						A2($author$project$DataChooser$axesConfigMode, model.axesConfig, model.chartMode)
					]),
					A3(
					...
					uni ? _List_fromArray(
					[
						A5($author$project$DataChooser$uniChooserButtons, model.chartMode, model.axesConfig, uniSearchText, model.uniSearchResults, model.unis)
					]) : _List_Nil,
					A3(
					$author$project$DataChooser$showChooserButton,
					question,
					...
					[
						A2($author$project$DataChooser$questionChooserButtons, model.axesConfig, model.questions)
					]) : _List_Nil,
					function () {
					var _v1 = model.chartMode;
					if (_v1.$ === 'BySubject') {
					...
					function () {
					var _v2 = model.chartMode;
					if (_v2.$ === 'BySubject') {
						var maybeSubject = _v2.a;
						return subject ? _List_fromArray(
							[
								A6($author$project$DataChooser$subjectChooserButtons, model.axesConfig, model.chartMode, model.unis, subjectSearchText, model.subjectSearchResults, maybeSubject)
							]) : _List_Nil;
					} else {
						return _List_Nil;
					}
...
var $author$project$DataChooser$defaultConf = {question: false, subject: false, subjectSearchText: '', uni: false, uniSearchText: ''};
	...
	switch (chooserMode.$) {
		case 'Uni':
			...
			return _Utils_update(
				...
				{uni: true, uniSearchText: searchText});
		case 'Question':
			return _Utils_update(
				$author$project$DataChooser$defaultConf,
				{question: true});
		case 'Subject':
			...
			return _Utils_update(
				$author$project$DataChooser$defaultConf,
				{subject: true, subjectSearchText: searchText});
		default:
...
var $author$project$DataChooser$dataChooserButtons = function (model) {
	return A2(
		...
		$author$project$DataChooser$makeChooserConfig(model.chooserMode),
		model);
};
...
var $author$project$Chart$makeCaption = function (model) {
	var _v0 = _Utils_Tuple2(
		_Utils_Tuple2(model.axesConfig, model.chartMode),
		_Utils_Tuple2(model.questions, model.unis));
	_v0$7:
	while (true) {
		if (_v0.a.a.$ === 'UniVsA') {
			if (_v0.a.b.$ === 'Overall') {
			...
			if (_v0.a.b.$ === 'Overall') {
				...
				if (((_v0.a.b.a.$ === 'Just') && _v0.b.b.b) && (!_v0.b.b.b.b)) {
					var _v29 = _v0.a;
					var _v30 = _v29.a;
